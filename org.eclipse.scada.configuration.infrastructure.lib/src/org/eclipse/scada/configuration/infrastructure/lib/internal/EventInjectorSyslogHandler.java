...
public class EventInjectorSyslogHandler implements ModuleHandler
{
    ...
    static
    {
        BUNDLES.add ( "org.eclipse.scada.ae.server.syslog" ); //$NON-NLS-1$
    }
    ...
    public void process ( final Module module, final Collection<ApplicationModule> modules, final EquinoxApplication app, final org.eclipse.scada.configuration.world.osgi.EquinoxApplication implApp )
    {
        ...
        final EventInjectorSyslog s = OsgiFactory.eINSTANCE.createEventInjectorSyslog ();
