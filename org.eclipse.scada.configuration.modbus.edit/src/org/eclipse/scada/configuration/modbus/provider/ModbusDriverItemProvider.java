...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.modbus.ModbusDriver} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModbusDriverItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
     ...
     * @generated
     */
    public ModbusDriverItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ModbusPackage.Literals.MODBUS_DRIVER__MASTERS );
        }
    ...
    {
        String label = ( (ModbusDriver)object ).getName ();
        return label == null || label.length () == 0 ? getString ( "_UI_ModbusDriver_type" ) : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add ( createChildParameter ( ModbusPackage.Literals.MODBUS_DRIVER__MASTERS, ModbusFactory.eINSTANCE.createModbusMaster () ) );
    }
