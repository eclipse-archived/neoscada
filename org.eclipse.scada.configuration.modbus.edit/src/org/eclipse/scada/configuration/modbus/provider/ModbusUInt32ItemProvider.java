...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.modbus.ModbusUInt32} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModbusUInt32ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
     ...
     * @generated
     */
    public ModbusUInt32ItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ModbusUInt32" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (ModbusUInt32)object ).getName ();
        return label == null || label.length () == 0 ? getString ( "_UI_ModbusUInt32_type" ) : //$NON-NLS-1$
        getString ( "_UI_ModbusUInt32_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ModbusUInt32.class ) )
        {
            case ModbusPackage.MODBUS_UINT32__NAME:
            case ModbusPackage.MODBUS_UINT32__SCALE:
