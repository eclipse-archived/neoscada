...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.modbus.ModbusSInt16} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModbusSInt16ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
     ...
     * @generated
     */
    public ModbusSInt16ItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ModbusSInt16" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (ModbusSInt16)object ).getName ();
        return label == null || label.length () == 0 ? getString ( "_UI_ModbusSInt16_type" ) : //$NON-NLS-1$
        getString ( "_UI_ModbusSInt16_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ModbusSInt16.class ) )
        {
