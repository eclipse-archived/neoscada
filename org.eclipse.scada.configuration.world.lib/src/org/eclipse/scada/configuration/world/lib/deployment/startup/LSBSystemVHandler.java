...
public class LSBSystemVHandler extends AbstractStartupHandler
{
    ...
    {
        context.addFile ( Contents.createContent ( LSBSystemVHandler.class.getResourceAsStream ( "templates/lsb_sysv/driver.service.sh" ), replacements, ALT_PATTERN ), "/etc/init.d/scada.driver." + driverName, new FileInformation ( 0755 ) );
    }
    ...
    {
        context.addFile ( Contents.createContent ( LSBSystemVHandler.class.getResourceAsStream ( "templates/lsb_sysv/p2.service.sh" ), replacements, ALT_PATTERN ), "/etc/init.d/scada.app." + appName, new FileInformation ( 0755 ) );
        context.addFile ( Contents.createContent ( LSBSystemVHandler.class.getResourceAsStream ( "templates/redhat_sysv/p2.launcher.sh" ), replacements, ALT_PATTERN ), "/usr/bin/scada.app." + appName + ".launcher", new FileInformation ( 0755 ) );
    }
