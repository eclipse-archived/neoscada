...
public class RedhatSystemVHandler implements StartupHandler
{
    ...
    {
        builder.addFile ( Contents.createContent ( RedhatSystemVHandler.class.getResourceAsStream ( "templates/redhat_sysv/driver.service.sh" ), replacements, ALT_PATTERN ), "/etc/init.d/scada.driver." + driverName, EntryInformation.DEFAULT_FILE_EXEC );
    }
    ...
    public void createEquinox ( final BinaryPackageBuilder builder, final String appName, final Map<String, String> replacements, final IProgressMonitor monitor ) throws Exception
    {
        ...
        builder.addFile ( Contents.createContent ( RedhatSystemVHandler.class.getResourceAsStream ( "templates/redhat_sysv/p2.service.sh" ), replacements, ALT_PATTERN ), "/etc/init.d/scada.app." + appName, EntryInformation.DEFAULT_FILE_EXEC );
        builder.addFile ( Contents.createContent ( RedhatSystemVHandler.class.getResourceAsStream ( "templates/redhat_sysv/p2.launcher.sh" ), replacements, ALT_PATTERN ), "/usr/bin/scada.app." + appName + ".launcher", EntryInformation.DEFAULT_FILE_EXEC );
    }
