...
public class AverageItemGenerator extends ItemGenerator
{
    private final AverageItem item;

    public AverageItemGenerator ( final AverageItem item, final OscarContext ctx, final MasterHandlerPriorities priorities )
    {
