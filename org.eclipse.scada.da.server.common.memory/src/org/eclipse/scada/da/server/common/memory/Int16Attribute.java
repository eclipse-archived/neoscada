 ...
 * @author Jens Reimann
 */
public class Int16Attribute extends AbstractAccessorAttribute<Short>
{
    public Int16Attribute ( final String name, final int index, final ByteOrder order, final boolean enableTimestamp )
    {
        super ( name, index, order, enableTimestamp, Int16Accessor.INSTANCE );
    }
