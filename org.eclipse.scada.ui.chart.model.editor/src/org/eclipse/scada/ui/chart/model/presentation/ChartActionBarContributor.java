 ...
 * @generated
 */
public class ChartActionBarContributor extends
	...
	protected IAction refreshViewerAction = new Action(
			ChartEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("chart-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("chart-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ChartEditorPlugin.INSTANCE.getString("_UI_ChartEditor_menu"), "org.eclipse.scada.ui.chart.modelMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
