...
public class RandomLongDataSourceFactory extends AbstractDataSourceFactory
{
    public RandomLongDataSourceFactory ( final BundleContext context, final ScheduledExecutorService scheduler )
    {
    ...
    {
        return new RandomLongDataSource ( getScheduler () );
    }
