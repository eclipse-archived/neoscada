...
public class TimeShiftActionFactory implements ChartControllerFactory
{
    ...
    {
        return new TimeShiftActionController ( controllerManager, chartContext, (TimeShiftAction)controller );
    }
