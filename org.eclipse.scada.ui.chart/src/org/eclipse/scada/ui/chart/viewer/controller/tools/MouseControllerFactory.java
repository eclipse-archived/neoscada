...
public class MouseControllerFactory implements ChartControllerFactory
{
    ...
    {
        return new MouseControllerImpl ( controllerManager, chartContext, (MouseController)controller );
    }
