...
public class TimeNowActionFactory implements ChartControllerFactory
{
    ...
    {
        return new TimeNowActionController ( controllerManager, chartContext, (TimeNowAction)controller );
    }
