...
public class ResetControllerFactory implements ChartControllerFactory
{
    ...
    {
        return new ResetControllerImpl ( controllerManager, chartContext, (ResetController)controller );
    }
