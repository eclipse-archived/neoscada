...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.driver.parser.ParserDriver} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParserDriverItemProvider
        ...
        IItemPropertySource
{
     ...
     * @generated
     */
    public ParserDriverItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ParserPackage.Literals.PARSER_DRIVER__COMPONENTS );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ParserDriver" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (ParserDriver)object ).getName ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_ParserDriver_type" ) : //$NON-NLS-1$
                getString ( "_UI_ParserDriver_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ParserDriver.class ) )
        {
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add
                ( createChildParameter
                ( ParserPackage.Literals.PARSER_DRIVER__COMPONENTS,
