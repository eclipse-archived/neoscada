...
public class BrowseResult implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( BrowseResult.class );

    public static final int MESSAGE_CODE = 4626;
    ...
    {
        return org.eclipse.scada.da.data.message.BrowseResult.class;
    }

    @Override
    public org.eclipse.scada.da.data.message.BrowseResult decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        java.util.List<org.eclipse.scada.da.data.BrowserEntry> browserData = null;
        ...
        for ( int i = 0; i < numberOfFields; i++ )
        {
            ...
            switch ( fieldNumber )
            {
                ...
                case 2:
                {
                    browserData = org.eclipse.scada.da.protocol.ngp.codec.Structures.decodeListBrowserEntry ( _context, _data, true );
                }
                    break;
                case 3:
                {
        ...
        // create object
        return new org.eclipse.scada.da.data.message.BrowseResult ( response, browserData, errorInformation );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.da.data.message.BrowseResult value = (org.eclipse.scada.da.data.message.BrowseResult)objectMessage;
        ...
        org.eclipse.scada.da.protocol.ngp.codec.Structures.encodeCollectionBrowserEntry ( context, data, (byte)2, value.getBrowserData () );
