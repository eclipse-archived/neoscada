...
public class StartWriteValue implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( StartWriteValue.class );

    public static final int MESSAGE_CODE = 4353;
    ...
    {
        return org.eclipse.scada.da.data.message.StartWriteValue.class;
    }

    @Override
    public org.eclipse.scada.da.data.message.StartWriteValue decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        // create object
        return new org.eclipse.scada.da.data.message.StartWriteValue ( request, itemId, value, operationParameters, callbackHandlerId );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.da.data.message.StartWriteValue value = (org.eclipse.scada.da.data.message.StartWriteValue)objectMessage;
        ...
        context.encodeVariant ( data, (byte)3, value.getValue () );
