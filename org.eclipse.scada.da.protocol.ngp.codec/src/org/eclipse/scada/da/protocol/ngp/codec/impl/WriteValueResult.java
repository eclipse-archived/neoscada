...
{
    private final static Logger logger = LoggerFactory.getLogger ( WriteValueResult.class );
    ...
    {
        return org.eclipse.scada.da.data.message.WriteValueResult.class;
    }
    ...
    {
        final org.eclipse.scada.da.data.message.WriteValueResult value = (org.eclipse.scada.da.data.message.WriteValueResult)objectMessage;
