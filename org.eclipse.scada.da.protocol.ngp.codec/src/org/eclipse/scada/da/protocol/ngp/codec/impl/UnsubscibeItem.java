...
public class UnsubscibeItem implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( UnsubscibeItem.class );

    public static final int MESSAGE_CODE = 4098;
    ...
    {
        return org.eclipse.scada.da.data.message.UnsubscibeItem.class;
    }

    @Override
    public org.eclipse.scada.da.data.message.UnsubscibeItem decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        // create object
        return new org.eclipse.scada.da.data.message.UnsubscibeItem ( itemId );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.da.data.message.UnsubscibeItem value = (org.eclipse.scada.da.data.message.UnsubscibeItem)objectMessage;
