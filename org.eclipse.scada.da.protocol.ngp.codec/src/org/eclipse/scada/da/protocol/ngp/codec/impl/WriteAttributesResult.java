...
public class WriteAttributesResult implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( WriteAttributesResult.class );
    ...
    @Override
    public org.eclipse.scada.da.data.message.WriteAttributesResult decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        java.util.List<org.eclipse.scada.da.data.AttributeWriteResultEntry> attributeResults = null;
        ...
        for ( int i = 0; i < numberOfFields; i++ )
        {
            ...
            switch ( fieldNumber )
            {
                ...
                case 2:
                {
                    attributeResults = org.eclipse.scada.da.protocol.ngp.codec.Structures.decodeListAttributeWriteResultEntry ( _context, _data, true );
                }
                    break;
                case 3:
                {
    ...
    {
        final org.eclipse.scada.da.data.message.WriteAttributesResult value = (org.eclipse.scada.da.data.message.WriteAttributesResult)objectMessage;
        ...
        org.eclipse.scada.da.protocol.ngp.codec.Structures.encodeCollectionAttributeWriteResultEntry ( context, data, (byte)2, value.getAttributeResults () );
