...
public class UnsubscribeFolder implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( UnsubscribeFolder.class );

    public static final int MESSAGE_CODE = 4610;
    ...
    {
        return org.eclipse.scada.da.data.message.UnsubscribeFolder.class;
    }

    @Override
    public org.eclipse.scada.da.data.message.UnsubscribeFolder decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        // create object
        return new org.eclipse.scada.da.data.message.UnsubscribeFolder ( location );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.da.data.message.UnsubscribeFolder value = (org.eclipse.scada.da.data.message.UnsubscribeFolder)objectMessage;
