...
import org.eclipse.scada.configuration.arduino.util.ArduinoResourceFactoryImpl;
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put
                ( Resource.Factory.Registry.DEFAULT_EXTENSION,
                        new ArduinoResourceFactoryImpl () );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.arduino" ) ); //$NON-NLS-1$
                ArduinoDriver root = ArduinoFactory.eINSTANCE.createArduinoDriver ();
