 ...
 * @generated
 */
public class FileInputImpl extends MinimalEObjectImpl.Container implements FileInput
{
    /**
    ...
    {
        return new org.eclipse.scada.base.extractor.input.file.FileInput ( creationContext.getExecutor (), new File ( getFileName () ) );
    }
    ...
    public Object eInvoke ( int operationID, EList<?> arguments ) throws InvocationTargetException
    {
        switch ( operationID )
        {
            case ParserPackage.FILE_INPUT___CREATE_INPUT__CREATIONCONTEXT:
