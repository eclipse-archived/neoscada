...
public class SecurityActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    ...
    public void contributeToMenu ( IMenuManager menuManager )
    {
        ...
        IMenuManager submenuManager = new MenuManager ( SecurityEditorPlugin.INSTANCE.getString ( "_UI_SecurityEditor_menu" ), "org.eclipse.scada.configuration.securityMenuID" ); //$NON-NLS-1$ //$NON-NLS-2$
