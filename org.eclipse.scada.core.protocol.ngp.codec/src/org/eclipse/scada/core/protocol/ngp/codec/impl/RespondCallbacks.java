...
public class RespondCallbacks implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( RespondCallbacks.class );
    ...
    {
        final org.eclipse.scada.core.data.message.RespondCallbacks value = (org.eclipse.scada.core.data.message.RespondCallbacks)objectMessage;
        ...
        org.eclipse.scada.core.protocol.ngp.codec.Structures.encodeCollectionCallbackResponse ( context, data, (byte)2, value.getCallbacks () );
