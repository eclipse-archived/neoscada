...
import org.eclipse.scada.configuration.item.util.ItemResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>item</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put
                ( Resource.Factory.Registry.DEFAULT_EXTENSION,
                        new ItemResourceFactoryImpl () );

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry ().put
                ( ItemPackage.eNS_URI,
                        ItemPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.icm" ) ); //$NON-NLS-1$
                CompositePipeline root = ItemFactory.eINSTANCE.createCompositePipeline ();
