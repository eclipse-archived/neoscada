 ...
 * {@link org.eclipse.scada.configuration.arduino.ArduinoConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ArduinoConnectionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
     ...
     * @generated
     */
    public ArduinoConnectionItemProvider ( final AdapterFactory adapterFactory )
    {
    ...
    protected void addEndpointPropertyDescriptor ( final Object object )
    {
        this.itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ArduinoConnection_endpoint_feature" ), //$NON-NLS-1$
                        ...
                        ArduinoPackage.Literals.ARDUINO_CONNECTION__ENDPOINT,
                        true,
                        false,
                        true,
                        null,
    ...
    {
        final String label = ( (ArduinoConnection)object ).getName ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_ArduinoConnection_type" ) : //$NON-NLS-1$
