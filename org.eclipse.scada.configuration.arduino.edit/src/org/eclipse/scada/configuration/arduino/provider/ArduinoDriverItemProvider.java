...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.arduino.ArduinoDriver} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArduinoDriverItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
     ...
     * @generated
     */
    public ArduinoDriverItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ArduinoPackage.Literals.ARDUINO_DRIVER__ARDUINO_CONNECTIONS );
        }
    ...
    /**
     * This returns ArduinoDriver.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ArduinoDriver" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (ArduinoDriver)object ).getName ();
        return label == null || label.length () == 0 ? getString ( "_UI_ArduinoDriver_type" ) : //$NON-NLS-1$
        getString ( "_UI_ArduinoDriver_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ArduinoDriver.class ) )
        {
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add ( createChildParameter ( ArduinoPackage.Literals.ARDUINO_DRIVER__ARDUINO_CONNECTIONS, ArduinoFactory.eINSTANCE.createArduinoConnection () ) );
    }
