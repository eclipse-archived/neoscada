...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.arduino.ArduinoDevice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArduinoDeviceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
     ...
     * @generated
     */
    public ArduinoDeviceItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    {
        String label = ( (ArduinoDevice)object ).getName ();
