...
public class GetFactoryWithDataResponse implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( GetFactoryWithDataResponse.class );

    public static final int MESSAGE_CODE = 16388;
    ...
    {
        return org.eclipse.scada.ca.data.message.GetFactoryWithDataResponse.class;
    }

    @Override
    public org.eclipse.scada.ca.data.message.GetFactoryWithDataResponse decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        org.eclipse.scada.ca.data.FactoryInformation factory = null;
        ...
        for ( int i = 0; i < numberOfFields; i++ )
        {
            ...
            switch ( fieldNumber )
            {
                ...
                case 2:
                {
                    factory = org.eclipse.scada.ca.protocol.ngp.codec.Structures.decodeFactoryInformation ( _context, _data, false );
                }
                    break;
                default:
        ...
        // create object
        return new org.eclipse.scada.ca.data.message.GetFactoryWithDataResponse ( response, factory );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.ca.data.message.GetFactoryWithDataResponse value = (org.eclipse.scada.ca.data.message.GetFactoryWithDataResponse)objectMessage;
        ...
        org.eclipse.scada.ca.protocol.ngp.codec.Structures.encodeFactoryInformation ( context, data, (byte)2, value.getFactory () );
