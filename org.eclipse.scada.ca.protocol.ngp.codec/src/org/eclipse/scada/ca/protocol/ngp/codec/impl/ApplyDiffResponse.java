...
public class ApplyDiffResponse implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( ApplyDiffResponse.class );

    public static final int MESSAGE_CODE = 16642;
    ...
    {
        return org.eclipse.scada.ca.data.message.ApplyDiffResponse.class;
    }
    ...
    {
        final org.eclipse.scada.ca.data.message.ApplyDiffResponse value = (org.eclipse.scada.ca.data.message.ApplyDiffResponse)objectMessage;
