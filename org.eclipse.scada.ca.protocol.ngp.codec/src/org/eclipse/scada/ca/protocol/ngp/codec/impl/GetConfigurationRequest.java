...
public class GetConfigurationRequest implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( GetConfigurationRequest.class );
    ...
    {
        final org.eclipse.scada.ca.data.message.GetConfigurationRequest value = (org.eclipse.scada.ca.data.message.GetConfigurationRequest)objectMessage;
