...
public class GetFactoriesResponse implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( GetFactoriesResponse.class );

    public static final int MESSAGE_CODE = 16386;
    ...
    {
        return org.eclipse.scada.ca.data.message.GetFactoriesResponse.class;
    }

    @Override
    public org.eclipse.scada.ca.data.message.GetFactoriesResponse decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        java.util.List<org.eclipse.scada.ca.data.FactoryInformation> factories = null;
        ...
        for ( int i = 0; i < numberOfFields; i++ )
        {
            ...
            switch ( fieldNumber )
            {
                ...
                case 2:
                {
                    factories = org.eclipse.scada.ca.protocol.ngp.codec.Structures.decodeListFactoryInformation ( _context, _data, true );
                }
                    break;
                default:
        ...
        // create object
        return new org.eclipse.scada.ca.data.message.GetFactoriesResponse ( response, factories );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.ca.data.message.GetFactoriesResponse value = (org.eclipse.scada.ca.data.message.GetFactoriesResponse)objectMessage;
        ...
        org.eclipse.scada.ca.protocol.ngp.codec.Structures.encodeCollectionFactoryInformation ( context, data, (byte)2, value.getFactories () );
