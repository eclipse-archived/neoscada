...
/**
 * Entry point of the 'GenerateData' generation module.
 * 
 * @generated
 */
public class GenerateData extends AbstractAcceleoGenerator
{
    /**
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/scada/protocol/ngp/generator/main/generateData";
     ...
     * @generated
     */
    public GenerateData ( URI modelURI, File targetFolder, List<? extends Object> arguments ) throws IOException
    {
     ...
     * @generated
     */
    public GenerateData ( EObject model, File targetFolder, List<? extends Object> arguments ) throws IOException
    {
    ...
    public static void main ( String[] args )
    {
        try {
            if (args.length < 2) {
                ...
                GenerateData generator = new GenerateData(modelURI, folder, arguments);
