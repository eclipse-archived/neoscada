...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.protocol.ngp.model.Protocol.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider extends DocumentedElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addLiteralsPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_Enum_literals_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_Enum_literals_feature", "_UI_Enum_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ProtocolPackage.Literals.ENUM__LITERALS,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ProtocolPackage.Literals.ENUM__LITERALS );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/Enum" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (org.eclipse.scada.protocol.ngp.model.Protocol.Enum)object ).getName ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_Enum_type" ) : //$NON-NLS-1$
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add
                ...
                ( ProtocolPackage.Literals.ENUM__LITERALS, "" ) ); //$NON-NLS-1$
    }
