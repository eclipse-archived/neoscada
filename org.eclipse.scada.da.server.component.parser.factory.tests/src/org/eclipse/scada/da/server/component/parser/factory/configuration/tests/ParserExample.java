...
public class ParserExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.parser" ) ); //$NON-NLS-1$
                Component root = ParserFactory.eINSTANCE.createComponent ();
