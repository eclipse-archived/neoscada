 ...
 * @generated
 */
public class DeploymentInformationTest extends TestCase {
	 ...
	 * @generated
	 */
	protected DeploymentInformation fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(DeploymentInformationTest.class);
	}
	 ...
	 * @generated
	 */
	public DeploymentInformationTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(DeploymentInformation fixture) {
	 ...
	 * @generated
	 */
	protected DeploymentInformation getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(DeploymentFactory.eINSTANCE.createDeploymentInformation());
	}
