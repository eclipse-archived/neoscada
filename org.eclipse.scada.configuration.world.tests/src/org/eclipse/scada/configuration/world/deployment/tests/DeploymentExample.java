...
import org.eclipse.scada.configuration.world.deployment.util.DeploymentResourceFactoryImpl;
...
public class DeploymentExample {
	...
	public static void main(String[] args) {
		...
		resourceSet
				...
				.put(DeploymentPackage.eCONTENT_TYPE,
		...
		resourceSet
				...
				.add(new RootXMLContentHandlerImpl(
						DeploymentPackage.eCONTENT_TYPE, null, null,
						DeploymentPackage.eNS_URI, null));

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(DeploymentPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet
						.createResource(
								URI.createURI("http:///My.esdi"), DeploymentPackage.eCONTENT_TYPE); //$NON-NLS-1$
				DebianDeploymentMechanism root = DeploymentFactory.eINSTANCE
