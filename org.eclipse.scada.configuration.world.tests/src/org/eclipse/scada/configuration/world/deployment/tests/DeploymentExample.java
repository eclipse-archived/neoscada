...
public class DeploymentExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.esdi" ), DeploymentPackage.eCONTENT_TYPE ); //$NON-NLS-1$
                DebianDeploymentMechanism root = DeploymentFactory.eINSTANCE.createDebianDeploymentMechanism ();
