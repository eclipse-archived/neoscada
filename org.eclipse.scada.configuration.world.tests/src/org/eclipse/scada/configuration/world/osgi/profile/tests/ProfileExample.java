...
public class ProfileExample {
	...
	public static void main(String[] args) {
		...
		resourceSet
				...
				.put(ProfilePackage.eCONTENT_TYPE,
		...
		resourceSet
				...
				.add(new RootXMLContentHandlerImpl(
						ProfilePackage.eCONTENT_TYPE, null, null,
						ProfilePackage.eNS_URI, null));

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(ProfilePackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet
						.createResource(
								URI.createURI("http:///My.xml"), ProfilePackage.eCONTENT_TYPE); //$NON-NLS-1$
