...
import org.eclipse.scada.configuration.world.setup.util.SetupResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>setup</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SetupExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.setup" ) ); //$NON-NLS-1$
                OperatingSystemDescriptor root = SetupFactory.eINSTANCE.createOperatingSystemDescriptor ();
