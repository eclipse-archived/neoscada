...
public class MemoryPackageImpl extends EPackageImpl implements MemoryPackage
{
     ...
     * @generated
     */
    public EAttribute getUserDefinedType_Index ()
    {
     ...
     * @generated
     */
    public EAttribute getBaseScalarType_Index ()
    {
        return (EAttribute)baseScalarTypeEClass.getEStructuralFeatures ().get ( 0 );
    }
    ...
    public void createPackageContents ()
    {
        ...
        createEAttribute ( baseScalarTypeEClass, BASE_SCALAR_TYPE__INDEX );

        userDefinedTypeEClass = createEClass ( USER_DEFINED_TYPE );
        createEReference ( userDefinedTypeEClass, USER_DEFINED_TYPE__TYPE );
        createEAttribute ( userDefinedTypeEClass, USER_DEFINED_TYPE__INDEX );
    ...
    public void initializePackageContents ()
    {
        ...
        initEAttribute ( getBaseScalarType_Index (), ecorePackage.getEInt (), "index", null, 1, 1, BaseScalarType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED ); //$NON-NLS-1$
        ...
        initEAttribute ( getUserDefinedType_Index (), ecorePackage.getEInt (), "index", null, 1, 1, UserDefinedType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED ); //$NON-NLS-1$
