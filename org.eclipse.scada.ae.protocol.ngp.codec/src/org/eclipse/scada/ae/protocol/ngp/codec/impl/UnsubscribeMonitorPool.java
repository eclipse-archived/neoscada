...
public class UnsubscribeMonitorPool implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( UnsubscribeMonitorPool.class );

    public static final int MESSAGE_CODE = 8194;
    ...
    {
        return org.eclipse.scada.ae.data.message.UnsubscribeMonitorPool.class;
    }

    @Override
    public org.eclipse.scada.ae.data.message.UnsubscribeMonitorPool decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        // create object
        return new org.eclipse.scada.ae.data.message.UnsubscribeMonitorPool ( monitorPoolId );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.ae.data.message.UnsubscribeMonitorPool value = (org.eclipse.scada.ae.data.message.UnsubscribeMonitorPool)objectMessage;
