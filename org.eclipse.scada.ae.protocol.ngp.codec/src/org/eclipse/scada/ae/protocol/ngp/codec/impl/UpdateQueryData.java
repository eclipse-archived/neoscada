...
public class UpdateQueryData implements BinaryMessageCodec
{
    ...
    {
        final org.eclipse.scada.ae.data.message.UpdateQueryData value = (org.eclipse.scada.ae.data.message.UpdateQueryData)objectMessage;
        ...
        org.eclipse.scada.ae.protocol.ngp.codec.Structures.encodeCollectionEventInformation ( context, data, (byte)2, value.getEvents () );
