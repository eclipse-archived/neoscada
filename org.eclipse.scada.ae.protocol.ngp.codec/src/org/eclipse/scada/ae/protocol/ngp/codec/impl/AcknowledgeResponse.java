...
public class AcknowledgeResponse implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( AcknowledgeResponse.class );

    public static final int MESSAGE_CODE = 9218;
    ...
    {
        return org.eclipse.scada.ae.data.message.AcknowledgeResponse.class;
    }
    ...
    {
        final org.eclipse.scada.ae.data.message.AcknowledgeResponse value = (org.eclipse.scada.ae.data.message.AcknowledgeResponse)objectMessage;
