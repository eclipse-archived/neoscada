...
public class UnsubscribeEventPool implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( UnsubscribeEventPool.class );

    public static final int MESSAGE_CODE = 8450;
    ...
    {
        return org.eclipse.scada.ae.data.message.UnsubscribeEventPool.class;
    }
    ...
    {
        final org.eclipse.scada.ae.data.message.UnsubscribeEventPool value = (org.eclipse.scada.ae.data.message.UnsubscribeEventPool)objectMessage;
