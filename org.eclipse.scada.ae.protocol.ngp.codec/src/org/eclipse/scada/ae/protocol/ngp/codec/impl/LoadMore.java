...
public class LoadMore implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( LoadMore.class );

    public static final int MESSAGE_CODE = 8706;
    ...
    {
        return org.eclipse.scada.ae.data.message.LoadMore.class;
    }
    ...
    {
        final org.eclipse.scada.ae.data.message.LoadMore value = (org.eclipse.scada.ae.data.message.LoadMore)objectMessage;
        ...
        context.encodePrimitiveInt ( data, (byte)2, value.getCount () );
