...
public class GalleryImpl extends MinimalEObjectImpl.Container implements Gallery {
	...
	protected EClass eStaticClass() {
		return WebPackage.Literals.GALLERY;
	}
	...
	public EList<Image> getImages() {
		if (images == null) {
			images = new EObjectContainmentEList<Image>(Image.class, this, WebPackage.GALLERY__IMAGES);
		}
		return images;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.GALLERY__LABEL, oldLabel, label));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebPackage.GALLERY__IMAGES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebPackage.GALLERY__IMAGES:
				return getImages();
			case WebPackage.GALLERY__LABEL:
				return getLabel();
		}
