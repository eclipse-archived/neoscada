...
public class ImageImpl extends MinimalEObjectImpl.Container implements Image {
	...
	protected EClass eStaticClass() {
		return WebPackage.Literals.IMAGE;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.IMAGE__LABEL, oldLabel, label));
	}
	...
	public void setSrc(String newSrc) {
		...
		src = newSrc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.IMAGE__SRC, oldSrc, src));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebPackage.IMAGE__LABEL:
				return getLabel();
			case WebPackage.IMAGE__SRC:
				return getSrc();
		}
