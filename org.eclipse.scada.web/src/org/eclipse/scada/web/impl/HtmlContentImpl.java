...
public class HtmlContentImpl extends MinimalEObjectImpl.Container implements HtmlContent {
	...
	protected EClass eStaticClass() {
		return WebPackage.Literals.HTML_CONTENT;
	}
	...
	public void setData(String newData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.HTML_CONTENT__DATA, oldData, data));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebPackage.HTML_CONTENT__DATA:
				return getData();
		}
