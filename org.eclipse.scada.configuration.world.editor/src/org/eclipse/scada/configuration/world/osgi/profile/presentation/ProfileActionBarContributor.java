...
public class ProfileActionBarContributor extends
	...
	protected IAction refreshViewerAction = new Action(
			WorldEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				WorldEditorPlugin.INSTANCE.getString("_UI_ProfileEditor_menu"), "org.eclipse.scada.configuration.world.osgi.profileMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
