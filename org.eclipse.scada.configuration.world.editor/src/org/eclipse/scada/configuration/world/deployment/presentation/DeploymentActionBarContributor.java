...
public class DeploymentActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    ...
    public void contributeToMenu ( IMenuManager menuManager )
    {
        ...
        IMenuManager submenuManager = new MenuManager ( WorldEditorPlugin.INSTANCE.getString ( "_UI_DeploymentEditor_menu" ), "org.eclipse.scada.configuration.world.deploymentMenuID" ); //$NON-NLS-1$ //$NON-NLS-2$
