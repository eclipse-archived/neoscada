...
import org.eclipse.scada.vi.chart.model.util.ChartResourceFactoryImpl;
...
public class ChartExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.chart" ) ); //$NON-NLS-1$
