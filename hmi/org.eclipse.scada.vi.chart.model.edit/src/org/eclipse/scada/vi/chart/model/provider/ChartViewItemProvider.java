...
import org.eclipse.scada.vi.model.provider.FigureItemProvider;

/**
 * This is the item provider adapter for a {@link org.eclipse.scada.vi.chart.model.ChartView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChartViewItemProvider extends FigureItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ChartView" ) ); //$NON-NLS-1$
    }
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_ChartView_type" ) : //$NON-NLS-1$
                getString ( "_UI_ChartView_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
