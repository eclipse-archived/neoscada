...
import org.eclipse.scada.configuration.driver.jdbc.util.JdbcResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>jdbc</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put
                ( Resource.Factory.Registry.DEFAULT_EXTENSION,
                        new JdbcResourceFactoryImpl () );

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry ().put
                ( JdbcPackage.eNS_URI,
                        JdbcPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.jdbc" ) ); //$NON-NLS-1$
                JdbcDriverInstance root = JdbcFactory.eINSTANCE.createJdbcDriverInstance ();
