...
/**
 * This is the action bar contributor for the Protocol model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class ProtocolActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action ( NextGenerationProtocolEditorPlugin.INSTANCE.getString ( "_UI_ShowPropertiesView_menu_item" ) ) {
        @Override
        public void run ()
        {
            try
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action ( NextGenerationProtocolEditorPlugin.INSTANCE.getString ( "_UI_RefreshViewer_menu_item" ) ) {
        @Override
        public boolean isEnabled ()
        {
            return ProtocolActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run ()
        {
            if ( ProtocolActionBarContributor.this.activeEditorPart instanceof IViewerProvider )
            {
                final Viewer viewer = ( (IViewerProvider)ProtocolActionBarContributor.this.activeEditorPart ).getViewer ();
                if ( viewer != null )
                {
                    viewer.refresh ();
                }
     ...
     * @generated
     */
    public ProtocolActionBarContributor ()
    {
    ...
    {
        toolBarManager.add ( new Separator ( "protocol-settings" ) );
        toolBarManager.add ( new Separator ( "protocol-additions" ) );
    }
    ...
    public void contributeToMenu ( final IMenuManager menuManager )
    {
        ...
        //
        this.createChildMenuManager = new MenuManager ( NextGenerationProtocolEditorPlugin.INSTANCE.getString ( "_UI_CreateChild_menu_item" ) );
        submenuManager.insertBefore ( "additions", this.createChildMenuManager );

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager ( NextGenerationProtocolEditorPlugin.INSTANCE.getString ( "_UI_CreateSibling_menu_item" ) );
    ...
    public void menuAboutToShow ( final IMenuManager menuManager )
    {
        ...
        submenuManager = new MenuManager ( NextGenerationProtocolEditorPlugin.INSTANCE.getString ( "_UI_CreateChild_menu_item" ) );
        populateManager ( submenuManager, this.createChildActions, null );
        menuManager.insertBefore ( "edit", submenuManager );

        submenuManager = new MenuManager ( NextGenerationProtocolEditorPlugin.INSTANCE.getString ( "_UI_CreateSibling_menu_item" ) );
