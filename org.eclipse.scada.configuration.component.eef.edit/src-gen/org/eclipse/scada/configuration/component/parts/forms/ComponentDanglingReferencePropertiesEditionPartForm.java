 ...
 * 
 */
public class ComponentDanglingReferencePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ComponentDanglingReferencePropertiesEditionPart {
	 ...
	 */
	public ComponentDanglingReferencePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ComponentDanglingReferencePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.ComponentDanglingReferencePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ComponentDanglingReferencePropertiesEditionPartForm.this,
							ComponentViewsRepository.ComponentDanglingReference.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComponentDanglingReferencePropertiesEditionPartForm.this, ComponentViewsRepository.ComponentDanglingReference.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ComponentViewsRepository.ComponentDanglingReference.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ComponentDanglingReference.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLocalTagMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editLocalTag = widgetFactory.createButton(parent, getDescription(ComponentViewsRepository.ComponentDanglingReference.Properties.localTag, ComponentMessages.ComponentDanglingReferencePropertiesEditionPart_LocalTagLabel), SWT.NONE);
		...
		editLocalTag.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComponentDanglingReferencePropertiesEditionPartForm.this, ComponentViewsRepository.ComponentDanglingReference.Properties.localTag, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(localTagList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createComponentFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		component = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.ComponentDanglingReference.Properties.component_, ComponentViewsRepository.FORM_KIND));
		...
		component.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComponentDanglingReferencePropertiesEditionPartForm.this, ComponentViewsRepository.ComponentDanglingReference.Properties.component_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getComponent()));
			}

		});
		component.setID(ComponentViewsRepository.ComponentDanglingReference.Properties.component_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ComponentDanglingReference.Properties.component_, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
