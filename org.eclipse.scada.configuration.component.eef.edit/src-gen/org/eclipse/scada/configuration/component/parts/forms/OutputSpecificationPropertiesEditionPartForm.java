 ...
 * 
 */
public class OutputSpecificationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, OutputSpecificationPropertiesEditionPart {
	 ...
	 */
	public OutputSpecificationPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public OutputSpecificationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.OutputSpecificationPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OutputSpecificationPropertiesEditionPartForm.this,
							ComponentViewsRepository.OutputSpecification.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSpecificationPropertiesEditionPartForm.this, ComponentViewsRepository.OutputSpecification.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ComponentViewsRepository.OutputSpecification.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.OutputSpecification.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDataTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		dataType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputSpecificationPropertiesEditionPartForm.this, ComponentViewsRepository.OutputSpecification.Properties.dataType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDataType()));
			}

		});
		dataType.setID(ComponentViewsRepository.OutputSpecification.Properties.dataType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.OutputSpecification.Properties.dataType, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
