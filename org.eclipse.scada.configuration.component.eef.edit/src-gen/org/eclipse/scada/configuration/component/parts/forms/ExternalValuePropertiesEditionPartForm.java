 ...
 * 
 */
public class ExternalValuePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ExternalValuePropertiesEditionPart {
	 ...
	 */
	public ExternalValuePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ExternalValuePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(externalValueStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ComponentViewsRepository.ExternalValue.Properties.sourceName) {
					return createSourceNameText(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.ExternalValuePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createLevelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		level = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.ExternalValue.Properties.level, ComponentViewsRepository.FORM_KIND));
		...
		level.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.level, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLevel()));
			}

		});
		level.setID(ComponentViewsRepository.ExternalValue.Properties.level);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.level, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCustomizationPipelineFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		customizationPipeline = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.ExternalValue.Properties.customizationPipeline, ComponentViewsRepository.FORM_KIND));
		...
		customizationPipeline.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.customizationPipeline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getCustomizationPipeline()));
			}

		});
		customizationPipeline.setID(ComponentViewsRepository.ExternalValue.Properties.customizationPipeline);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.customizationPipeline, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createArchiveSelectorFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		archiveSelector = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.ExternalValue.Properties.archiveSelector, ComponentViewsRepository.FORM_KIND));
		...
		archiveSelector.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.archiveSelector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getArchiveSelector()));
			}

		});
		archiveSelector.setID(ComponentViewsRepository.ExternalValue.Properties.archiveSelector);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.archiveSelector, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMasterOnReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.masterOn = new ReferencesTable(getDescription(ComponentViewsRepository.ExternalValue.Properties.masterOn, ComponentMessages.ExternalValuePropertiesEditionPart_MasterOnLabel), new ReferencesTableListener	() {
		...
		this.masterOn.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.masterOn, ComponentViewsRepository.FORM_KIND));
		...
		this.masterOn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.masterOn, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"masterOn", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.masterOn,
	...
	protected void moveMasterOn(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.masterOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		masterOn.refresh();
	}
	...
	protected void removeFromMasterOn(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.masterOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		masterOn.refresh();
	}
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ExternalValuePropertiesEditionPartForm.this,
							ComponentViewsRepository.ExternalValue.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ComponentViewsRepository.ExternalValue.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDataTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		dataType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.dataType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDataType()));
			}

		});
		dataType.setID(ComponentViewsRepository.ExternalValue.Properties.dataType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.dataType, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCustomizationTagsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editCustomizationTags = widgetFactory.createButton(parent, getDescription(ComponentViewsRepository.ExternalValue.Properties.customizationTags, ComponentMessages.ExternalValuePropertiesEditionPart_CustomizationTagsLabel), SWT.NONE);
		...
		editCustomizationTags.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.customizationTags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(customizationTagsList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createConnectionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		connection = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.ExternalValue.Properties.connection, ComponentViewsRepository.FORM_KIND));
		...
		connection.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.connection, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getConnection()));
			}

		});
		connection.setID(ComponentViewsRepository.ExternalValue.Properties.connection);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.connection, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSourceNameText(FormToolkit widgetFactory, Composite parent) {
		...
		sourceName = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		sourceName.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		sourceName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ExternalValuePropertiesEditionPartForm.this,
							ComponentViewsRepository.ExternalValue.Properties.sourceName,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, sourceName.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									ExternalValuePropertiesEditionPartForm.this,
									ComponentViewsRepository.ExternalValue.Properties.sourceName,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, sourceName.getText()));
				}
			}
		...
		sourceName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExternalValuePropertiesEditionPartForm.this, ComponentViewsRepository.ExternalValue.Properties.sourceName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, sourceName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ExternalValue.Properties.sourceName, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
