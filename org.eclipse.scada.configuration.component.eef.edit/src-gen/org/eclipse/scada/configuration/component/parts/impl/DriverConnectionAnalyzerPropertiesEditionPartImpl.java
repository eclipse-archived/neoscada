 ...
 * 
 */
public class DriverConnectionAnalyzerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DriverConnectionAnalyzerPropertiesEditionPart {
	 ...
	 * 
	 */
	public DriverConnectionAnalyzerPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ComponentMessages.DriverConnectionAnalyzerPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createLevelFlatComboViewer(Composite parent) {
		...
		level = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.level, ComponentViewsRepository.SWT_KIND));
		...
		level.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.level, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getLevel()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.level, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCustomizationPipelineFlatComboViewer(Composite parent) {
		...
		customizationPipeline = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.customizationPipeline, ComponentViewsRepository.SWT_KIND));
		...
		customizationPipeline.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.customizationPipeline, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getCustomizationPipeline()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.customizationPipeline, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createArchiveSelectorFlatComboViewer(Composite parent) {
		...
		archiveSelector = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.archiveSelector, ComponentViewsRepository.SWT_KIND));
		...
		archiveSelector.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.archiveSelector, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getArchiveSelector()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.archiveSelector, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMasterOnAdvancedReferencesTable(Composite parent) {
		String label = getDescription(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.masterOn, ComponentMessages.DriverConnectionAnalyzerPropertiesEditionPart_MasterOnLabel);		 
		...
		this.masterOn.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.masterOn, ComponentViewsRepository.SWT_KIND));
		this.masterOn.createControls(parent);
		this.masterOn.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.masterOn, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"masterOn", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.masterOn,
	...
	protected void moveMasterOn(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.masterOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		masterOn.refresh();
	}
	...
	protected void removeFromMasterOn(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.masterOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		masterOn.refresh();
	}
	...
	protected Composite createConnectionFlatComboViewer(Composite parent) {
		...
		connection = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.connection, ComponentViewsRepository.SWT_KIND));
		...
		connection.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DriverConnectionAnalyzerPropertiesEditionPartImpl.this, ComponentViewsRepository.DriverConnectionAnalyzer.Properties.connection, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getConnection()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.DriverConnectionAnalyzer.Properties.connection, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
