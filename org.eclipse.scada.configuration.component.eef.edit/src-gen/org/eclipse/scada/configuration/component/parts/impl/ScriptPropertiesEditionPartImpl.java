...
public class ScriptPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ScriptPropertiesEditionPart {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ComponentMessages.ScriptPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCodeText(Composite parent) {
		...
		code.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartImpl.this, ComponentViewsRepository.Script.Properties.code, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, code.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.Script.Properties.code, ComponentViewsRepository.SWT_KIND), null); //$NON-NLS-1$
