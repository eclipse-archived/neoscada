 ...
 * 
 */
public interface DataMapperAnalyzerPropertiesEditionPart {
	...
	/**
	 * Defines a new dataMapper
	 * @param newValue the new dataMapper to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the dataMapper edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
