 ...
 * 
 */
public class FormulaModulePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FormulaModulePropertiesEditionPart {
	 ...
	 */
	public FormulaModulePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public FormulaModulePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(formulaModuleStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ComponentViewsRepository.FormulaModule.Properties.init) {
					return createInitTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.FormulaModulePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createShortDescriptionText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FormulaModulePropertiesEditionPartForm.this,
							ComponentViewsRepository.FormulaModule.Properties.shortDescription,
		...
		shortDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.shortDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, shortDescription.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.FormulaModule.Properties.shortDescription, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FormulaModulePropertiesEditionPartForm.this,
							ComponentViewsRepository.FormulaModule.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ComponentViewsRepository.FormulaModule.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.FormulaModule.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createInputsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.inputs = new ReferencesTable(getDescription(ComponentViewsRepository.FormulaModule.Properties.inputs, ComponentMessages.FormulaModulePropertiesEditionPart_InputsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.inputs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				inputs.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.inputs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				inputs.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.inputs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				inputs.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.inputs, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				inputs.refresh();
			}
		...
		this.inputs.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.FormulaModule.Properties.inputs, ComponentViewsRepository.FORM_KIND));
		this.inputs.createControls(parent, widgetFactory);
		this.inputs.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.inputs, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createScriptEngineText(FormToolkit widgetFactory, Composite parent) {
		...
		scriptEngine.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FormulaModulePropertiesEditionPartForm.this,
							ComponentViewsRepository.FormulaModule.Properties.scriptEngine,
		...
		scriptEngine.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.scriptEngine, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, scriptEngine.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.FormulaModule.Properties.scriptEngine, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createInitTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.init = new ReferencesTable(getDescription(ComponentViewsRepository.FormulaModule.Properties.init, ComponentMessages.FormulaModulePropertiesEditionPart_InitLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.init, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				init.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.init, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				init.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.init, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				init.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.init, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				init.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.init.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.FormulaModule.Properties.init, ComponentViewsRepository.FORM_KIND));
		this.init.createControls(parent, widgetFactory);
		this.init.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FormulaModulePropertiesEditionPartForm.this, ComponentViewsRepository.FormulaModule.Properties.init, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createInitTableComposition
