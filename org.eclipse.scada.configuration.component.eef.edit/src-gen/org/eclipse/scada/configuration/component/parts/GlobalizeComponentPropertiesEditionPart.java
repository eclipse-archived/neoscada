 ...
 * 
 */
public interface GlobalizeComponentPropertiesEditionPart {
	...
	/**
	 * Init the components
	 * @param settings settings for the components ReferencesTable 
	 */
	...
	/**
	 * @return the sourceMaster
	 * 
	 */
	public EObject getSourceMaster();

	/**
	 * Init the sourceMaster
	 * @param settings the combo setting
	 */
	public void initSourceMaster(EObjectFlatComboSettings settings);

	/**
	 * Defines a new sourceMaster
	 * @param newValue the new sourceMaster to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the sourceMaster edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
