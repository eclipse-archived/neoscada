 ...
 * 
 */
public class PersistentValuePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, PersistentValuePropertiesEditionPart {
	 ...
	 */
	public PersistentValuePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public PersistentValuePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.PersistentValuePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createLevelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		level = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.PersistentValue.Properties.level, ComponentViewsRepository.FORM_KIND));
		...
		level.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.level, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLevel()));
			}

		});
		level.setID(ComponentViewsRepository.PersistentValue.Properties.level);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.PersistentValue.Properties.level, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCustomizationPipelineFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		customizationPipeline = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.PersistentValue.Properties.customizationPipeline, ComponentViewsRepository.FORM_KIND));
		...
		customizationPipeline.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.customizationPipeline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getCustomizationPipeline()));
			}

		});
		customizationPipeline.setID(ComponentViewsRepository.PersistentValue.Properties.customizationPipeline);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.PersistentValue.Properties.customizationPipeline, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createArchiveSelectorFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		archiveSelector = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ComponentViewsRepository.PersistentValue.Properties.archiveSelector, ComponentViewsRepository.FORM_KIND));
		...
		archiveSelector.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.archiveSelector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getArchiveSelector()));
			}

		});
		archiveSelector.setID(ComponentViewsRepository.PersistentValue.Properties.archiveSelector);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.PersistentValue.Properties.archiveSelector, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMasterOnReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.masterOn = new ReferencesTable(getDescription(ComponentViewsRepository.PersistentValue.Properties.masterOn, ComponentMessages.PersistentValuePropertiesEditionPart_MasterOnLabel), new ReferencesTableListener	() {
		...
		this.masterOn.setHelpText(propertiesEditionComponent.getHelpContent(ComponentViewsRepository.PersistentValue.Properties.masterOn, ComponentViewsRepository.FORM_KIND));
		...
		this.masterOn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.masterOn, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"masterOn", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.masterOn,
	...
	protected void moveMasterOn(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.masterOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		masterOn.refresh();
	}
	...
	protected void removeFromMasterOn(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.masterOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		masterOn.refresh();
	}
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PersistentValuePropertiesEditionPartForm.this,
							ComponentViewsRepository.PersistentValue.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ComponentViewsRepository.PersistentValue.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.PersistentValue.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDataTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		dataType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.dataType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDataType()));
			}

		});
		dataType.setID(ComponentViewsRepository.PersistentValue.Properties.dataType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.PersistentValue.Properties.dataType, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCustomizationTagsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editCustomizationTags = widgetFactory.createButton(parent, getDescription(ComponentViewsRepository.PersistentValue.Properties.customizationTags, ComponentMessages.PersistentValuePropertiesEditionPart_CustomizationTagsLabel), SWT.NONE);
		...
		editCustomizationTags.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PersistentValuePropertiesEditionPartForm.this, ComponentViewsRepository.PersistentValue.Properties.customizationTags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(customizationTagsList)));
					setHasChanged(true);
				}
			}
		});
