 ...
 * 
 */
public class ItemReferenceInputDefinitionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ItemReferenceInputDefinitionPropertiesEditionPart {
	 ...
	 */
	public ItemReferenceInputDefinitionPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ItemReferenceInputDefinitionPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(itemReferenceInputDefinitionStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ComponentViewsRepository.ItemReferenceInputDefinition.Properties.itemId) {
					return createItemIdText(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ComponentMessages.ItemReferenceInputDefinitionPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ItemReferenceInputDefinitionPropertiesEditionPartForm.this,
							ComponentViewsRepository.ItemReferenceInputDefinition.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ItemReferenceInputDefinitionPropertiesEditionPartForm.this, ComponentViewsRepository.ItemReferenceInputDefinition.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ComponentViewsRepository.ItemReferenceInputDefinition.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ItemReferenceInputDefinition.Properties.name, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createItemIdText(FormToolkit widgetFactory, Composite parent) {
		...
		itemId = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		itemId.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		itemId.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ItemReferenceInputDefinitionPropertiesEditionPartForm.this,
							ComponentViewsRepository.ItemReferenceInputDefinition.Properties.itemId,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, itemId.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									ItemReferenceInputDefinitionPropertiesEditionPartForm.this,
									ComponentViewsRepository.ItemReferenceInputDefinition.Properties.itemId,
		...
		itemId.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ItemReferenceInputDefinitionPropertiesEditionPartForm.this, ComponentViewsRepository.ItemReferenceInputDefinition.Properties.itemId, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, itemId.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ComponentViewsRepository.ItemReferenceInputDefinition.Properties.itemId, ComponentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
