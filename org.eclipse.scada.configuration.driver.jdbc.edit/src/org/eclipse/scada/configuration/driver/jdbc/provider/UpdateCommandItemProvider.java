...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.driver.jdbc.UpdateCommand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateCommandItemProvider
        ...
        IItemPropertySource
{
     ...
     * @generated
     */
    public UpdateCommandItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( JdbcPackage.Literals.UPDATE_COMMAND__MAPPINGS );
        }
    ...
    /**
     * This returns UpdateCommand.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/UpdateCommand" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (UpdateCommand)object ).getName ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_UpdateCommand_type" ) : //$NON-NLS-1$
                getString ( "_UI_UpdateCommand_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add
                ...
                ( JdbcPackage.Literals.UPDATE_COMMAND__MAPPINGS,
                        JdbcFactory.eINSTANCE.createUpdateMapping () ) );
    }
