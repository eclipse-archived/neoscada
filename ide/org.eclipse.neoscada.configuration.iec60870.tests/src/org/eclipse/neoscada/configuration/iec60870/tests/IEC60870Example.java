...
import org.eclipse.neoscada.configuration.iec60870.util.IEC60870ResourceFactoryImpl;
...
public class IEC60870Example
{
    ...
    public static void main ( String[] args )
    {
        ...
        //
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put ( Resource.Factory.Registry.DEFAULT_EXTENSION, new IEC60870ResourceFactoryImpl () );

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry ().put ( IEC60870Package.eNS_URI, IEC60870Package.eINSTANCE );
