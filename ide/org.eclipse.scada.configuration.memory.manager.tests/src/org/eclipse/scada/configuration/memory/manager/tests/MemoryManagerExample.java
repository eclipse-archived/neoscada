...
import org.eclipse.scada.configuration.memory.manager.util.MemoryManagerResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>manager</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put
                ( Resource.Factory.Registry.DEFAULT_EXTENSION,
                        new MemoryManagerResourceFactoryImpl () );

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry ().put
                ( MemoryManagerPackage.eNS_URI,
                        MemoryManagerPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.memorymanager" ) ); //$NON-NLS-1$
                MemoryManagerModule root = MemoryManagerFactory.eINSTANCE.createMemoryManagerModule ();
