...
public class MemoryManagerSwitch<T> extends Switch<T>
{
    ...
    protected T doSwitch ( int classifierID, EObject theEObject )
    {
        switch ( classifierID )
        {
            ...
            {
                MemoryManagerModule memoryManagerModule = (MemoryManagerModule)theEObject;
                T result = caseMemoryManagerModule ( memoryManagerModule );
                if ( result == null )
                    result = caseApplicationConfiguration ( memoryManagerModule );
                if ( result == null )
                    result = caseApplicationModule ( memoryManagerModule );
                if ( result == null )
     ...
     * @generated
     */
    public T caseMemoryManagerModule ( MemoryManagerModule object )
    {
        return null;
    }
