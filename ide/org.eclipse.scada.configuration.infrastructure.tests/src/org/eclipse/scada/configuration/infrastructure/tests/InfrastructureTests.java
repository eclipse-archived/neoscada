...
public class InfrastructureTests extends TestSuite
{
    ...
    {
        TestSuite suite = new InfrastructureTests ( "infrastructure Tests" ); //$NON-NLS-1$
        suite.addTestSuite ( SystemNodeTest.class );
        suite.addTestSuite ( ExternalDriverPlaceholderTest.class );
        return suite;
    }
