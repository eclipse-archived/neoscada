...
/**
 * This is the item provider adapter for a {@link org.eclipse.neoscada.configuration.iec60870.Exporter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExporterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( IEC60870Package.Literals.EXPORTER__DEVICES );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/Exporter" ) ); //$NON-NLS-1$
    }
    ...
    {
        return getString ( "_UI_Exporter_type" ); //$NON-NLS-1$
    }
