...
import org.eclipse.scada.configuration.recipe.util.RecipeResourceFactoryImpl;
...
public class RecipeExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getURIConverter ().getContentHandlers ().add
                ( new RootXMLContentHandlerImpl ( RecipePackage.eCONTENT_TYPE, null, null, RecipePackage.eNS_URI, null ) );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.recipe" ), RecipePackage.eCONTENT_TYPE ); //$NON-NLS-1$
                Definition root = RecipeFactory.eINSTANCE.createDefinition ();
