...
public class ScriptItemImpl extends ItemImpl implements ScriptItem
{
    ...
    public EList<ItemReference> getInputs ()
    {
        if ( inputs == null )
        {
            inputs = new EObjectContainmentEList.Resolving<ItemReference> ( ItemReference.class, this, OsgiPackage.SCRIPT_ITEM__INPUTS );
        }
        return inputs;
    }
    ...
    public NotificationChain basicSetInitScript ( CodeFragment newInitScript, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired () )
        {
            ENotificationImpl notification = new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__INIT_SCRIPT, oldInitScript, newInitScript );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setInitScript ( CodeFragment newInitScript )
    {
        if ( newInitScript != initScript )
        {
            ...
            if ( initScript != null )
                msgs = ( (InternalEObject)initScript ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__INIT_SCRIPT, null, msgs );
            if ( newInitScript != null )
                msgs = ( (InternalEObject)newInitScript ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__INIT_SCRIPT, null, msgs );
            msgs = basicSetInitScript ( newInitScript, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__INIT_SCRIPT, newInitScript, newInitScript ) );
    }
    ...
    public CodeFragment getUpdateScript ()
    {
        if ( updateScript != null && updateScript.eIsProxy () )
        {
            ...
            if ( updateScript != oldUpdateScript )
            {
                ...
                NotificationChain msgs = oldUpdateScript.eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__UPDATE_SCRIPT, null, null );
                if ( newUpdateScript.eInternalContainer () == null )
                {
                    msgs = newUpdateScript.eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__UPDATE_SCRIPT, null, msgs );
                }
                if ( msgs != null )
                    msgs.dispatch ();
                if ( eNotificationRequired () )
                    eNotify ( new ENotificationImpl ( this, Notification.RESOLVE, OsgiPackage.SCRIPT_ITEM__UPDATE_SCRIPT, oldUpdateScript, updateScript ) );
            }
        }
        return updateScript;
    }
    ...
    public void setUpdateScript ( CodeFragment newUpdateScript )
    {
        if ( newUpdateScript != updateScript )
        {
            ...
            if ( updateScript != null )
                msgs = ( (InternalEObject)updateScript ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__UPDATE_SCRIPT, null, msgs );
            if ( newUpdateScript != null )
                msgs = ( (InternalEObject)newUpdateScript ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__UPDATE_SCRIPT, null, msgs );
            msgs = basicSetUpdateScript ( newUpdateScript, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__UPDATE_SCRIPT, newUpdateScript, newUpdateScript ) );
    }
    ...
    public NotificationChain basicSetTimer ( ScriptTimer newTimer, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired () )
        {
            ENotificationImpl notification = new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__TIMER, oldTimer, newTimer );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add ( notification );
    ...
    public void setTimer ( ScriptTimer newTimer )
    {
        if ( newTimer != timer )
        {
            NotificationChain msgs = null;
            if ( timer != null )
                msgs = ( (InternalEObject)timer ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__TIMER, null, msgs );
            if ( newTimer != null )
                msgs = ( (InternalEObject)newTimer ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__TIMER, null, msgs );
            msgs = basicSetTimer ( newTimer, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__TIMER, newTimer, newTimer ) );
    }
    ...
    public void setScriptEngine ( String newScriptEngine )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__SCRIPT_ENGINE, oldScriptEngine, scriptEngine ) );
    }
    ...
    public EList<ItemReference> getCommands ()
    {
        if ( commands == null )
        {
            commands = new EObjectContainmentEList.Resolving<ItemReference> ( ItemReference.class, this, OsgiPackage.SCRIPT_ITEM__COMMANDS );
        }
        return commands;
    }
    ...
    public CodeFragment getWriteCommandScript ()
    {
        if ( writeCommandScript != null && writeCommandScript.eIsProxy () )
        {
            ...
            if ( writeCommandScript != oldWriteCommandScript )
            {
                ...
                NotificationChain msgs = oldWriteCommandScript.eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, null, null );
                if ( newWriteCommandScript.eInternalContainer () == null )
                {
                    msgs = newWriteCommandScript.eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, null, msgs );
                }
                if ( msgs != null )
                    msgs.dispatch ();
                if ( eNotificationRequired () )
                    eNotify ( new ENotificationImpl ( this, Notification.RESOLVE, OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, oldWriteCommandScript, writeCommandScript ) );
            }
        }
    ...
    public NotificationChain basicSetWriteCommandScript ( CodeFragment newWriteCommandScript, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired () )
        {
            ENotificationImpl notification = new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, oldWriteCommandScript, newWriteCommandScript );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add ( notification );
    ...
    public void setWriteCommandScript ( CodeFragment newWriteCommandScript )
    {
        if ( newWriteCommandScript != writeCommandScript )
        {
            ...
            if ( writeCommandScript != null )
                msgs = ( (InternalEObject)writeCommandScript ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, null, msgs );
            if ( newWriteCommandScript != null )
                msgs = ( (InternalEObject)newWriteCommandScript ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, null, msgs );
            msgs = basicSetWriteCommandScript ( newWriteCommandScript, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT, newWriteCommandScript, newWriteCommandScript ) );
    }
    ...
    public void eSet ( int featureID, Object newValue )
    {
        switch ( featureID )
        {
            ...
            case OsgiPackage.SCRIPT_ITEM__COMMANDS:
                getCommands ().clear ();
                getCommands ().addAll ( (Collection<? extends ItemReference>)newValue );
                return;
            case OsgiPackage.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT:
