...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.modbus.ModbusSInt32} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModbusSInt32ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
     ...
     * @generated
     */
    public ModbusSInt32ItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ModbusSInt32" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (ModbusSInt32)object ).getName ();
        return label == null || label.length () == 0 ? getString ( "_UI_ModbusSInt32_type" ) : //$NON-NLS-1$
        getString ( "_UI_ModbusSInt32_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ModbusSInt32.class ) )
        {
            case ModbusPackage.MODBUS_SINT32__NAME:
            case ModbusPackage.MODBUS_SINT32__SCALE:
