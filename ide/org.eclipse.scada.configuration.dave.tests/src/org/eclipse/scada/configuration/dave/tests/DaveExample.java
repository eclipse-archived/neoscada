...
import org.eclipse.scada.configuration.dave.util.DaveResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dave</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DaveExample
{
    /**
     * <!-- begin-user-doc -->
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put
                ( Resource.Factory.Registry.DEFAULT_EXTENSION,
                        new DaveResourceFactoryImpl () );

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry ().put
                ( DavePackage.eNS_URI,
                        DavePackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.dave" ) ); //$NON-NLS-1$
                DaveDevice root = DaveFactory.eINSTANCE.createDaveDevice ();
