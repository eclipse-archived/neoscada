...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.ApplicationNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationNodeItemProvider extends NodeItemProvider
{
    /**
     ...
     * @generated
     */
    public ApplicationNodeItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    /**
     * This returns ApplicationNode.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ApplicationNode" ) ); //$NON-NLS-1$
    }
    ...
    public Object getStyledText ( Object object )
    {
        ...
        {
            styledLabel.append ( getString ( "_UI_ApplicationNode_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_ApplicationNode_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
