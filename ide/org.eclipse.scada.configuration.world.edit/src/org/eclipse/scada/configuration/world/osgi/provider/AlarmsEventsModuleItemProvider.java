...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.osgi.AlarmsEventsModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlarmsEventsModuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, IItemStyledLabelProvider
{
    /**
     ...
     * @generated
     */
    public AlarmsEventsModuleItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( OsgiPackage.Literals.ALARMS_EVENTS_MODULE__MONITOR_POOL_PROXIES );
            childrenFeatures.add ( OsgiPackage.Literals.ALARMS_EVENTS_MODULE__EVENT_POOL_PROXIES );
            childrenFeatures.add ( OsgiPackage.Literals.ALARMS_EVENTS_MODULE__AKN_PROXIES );
            childrenFeatures.add ( OsgiPackage.Literals.ALARMS_EVENTS_MODULE__PULL_EVENTS );
        }
    ...
    /**
     * This returns AlarmsEventsModule.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/AlarmsEventsModule" ) ); //$NON-NLS-1$
    }
    ...
    {
        return new StyledString ( getString ( "_UI_AlarmsEventsModule_type" ) ); //$NON-NLS-1$
    }
