...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.osgi.SummaryGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SummaryGroupItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, IItemStyledLabelProvider
{
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( OsgiPackage.Literals.SUMMARY_GROUP__SUB_GROUPS );
            childrenFeatures.add ( OsgiPackage.Literals.SUMMARY_GROUP__ITEMS );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/SummaryGroup" ) ); //$NON-NLS-1$
    }
    ...
    public Object getStyledText ( Object object )
    {
        ...
        {
            styledLabel.append ( getString ( "_UI_SummaryGroup_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_SummaryGroup_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
