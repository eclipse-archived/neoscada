...
public class ScriptHandlerProcessor extends BasicEventHandlerProcessor implements EventHandlerProcessor
{

    public ScriptHandlerProcessor ()
    {
        super ( "include" );
    }
    ...
    {
        final ScriptEventHandler handler = (ScriptEventHandler)eventHandler;

        final Map<String, String> result = new HashMap<> ( 1 );
        result.put ( "script", handler.getScript ().getSource () );
        return result;
    }
