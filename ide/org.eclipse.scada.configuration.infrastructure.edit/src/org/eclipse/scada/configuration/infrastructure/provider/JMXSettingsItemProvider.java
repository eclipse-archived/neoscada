 ...
 * @generated
 */
public class JMXSettingsItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemStyledLabelProvider
{
    /**
    ...
    public Object getStyledText ( Object object )
    {
        ...
        return new StyledString ( getString ( "_UI_JMXSettings_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " ).append ( Boolean.toString ( jmxSettings.isAssignNodeHostname () ) ); //$NON-NLS-1$ //$NON-NLS-2$
    }
