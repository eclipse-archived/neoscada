 ...
 * @generated
 */
public class EventInjectorHttpItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemStyledLabelProvider
{
    /**
    ...
    {
        return new StyledString ( getString ( "_UI_EventInjectorHttp_type" ) ); //$NON-NLS-1$
    }
