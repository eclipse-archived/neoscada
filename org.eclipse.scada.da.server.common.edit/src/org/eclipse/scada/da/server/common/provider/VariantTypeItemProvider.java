 ...
 */
package org.eclipse.scada.da.server.common.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.da.server.common.VariantType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
    ...
    protected void addStringPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_VariantType_string_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_VariantType_string_feature", "_UI_VariantType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        CommonPackage.Literals.VARIANT_TYPE__STRING,
                        true,
                        false,
                        false,
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/VariantType" ) ); //$NON-NLS-1$
    }
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_VariantType_type" ) : //$NON-NLS-1$
                getString ( "_UI_VariantType_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add
                ...
                ( CommonPackage.Literals.VARIANT_TYPE__NULL,
                        CommonFactory.eINSTANCE.createVariantNullType () ) );

        newChildDescriptors.add
                ( createChildParameter
                ( CommonPackage.Literals.VARIANT_TYPE__INT32,
                        CommonFactory.eINSTANCE.createVariantInt32Type () ) );

        newChildDescriptors.add
                ( createChildParameter
                ( CommonPackage.Literals.VARIANT_TYPE__DOUBLE,
                        CommonFactory.eINSTANCE.createVariantDoubleType () ) );

        newChildDescriptors.add
                ( createChildParameter
                ( CommonPackage.Literals.VARIANT_TYPE__BOOLEAN,
                        CommonFactory.eINSTANCE.createVariantBooleanType () ) );

        newChildDescriptors.add
                ( createChildParameter
                ( CommonPackage.Literals.VARIANT_TYPE__INT64,
                        CommonFactory.eINSTANCE.createVariantInt64Type () ) );
    }
