 ...
 * <ul>
 *   <li>{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getSql <em>Sql</em>}</li>
 *   <li>{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getColumnMapping <em>Column Mapping</em>}</li>
 ...
 * </p>
 *
 * @see org.eclipse.scada.da.server.jdbc.configuration.ConfigurationPackage#getAbstractQueryType()
 * @model abstract="true"
...
public interface AbstractQueryType extends EObject
{
     ...
     * @see #setSql(String)
     * @see org.eclipse.scada.da.server.jdbc.configuration.ConfigurationPackage#getAbstractQueryType_Sql()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getSql <em>Sql</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.eclipse.scada.da.server.jdbc.configuration.ConfigurationPackage#getAbstractQueryType_ColumnMapping()
     ...
     * @see #setId(String)
     * @see org.eclipse.scada.da.server.jdbc.configuration.ConfigurationPackage#getAbstractQueryType_Id()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getId <em>Id</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #unsetPeriod()
     * @see #setPeriod(int)
     * @see org.eclipse.scada.da.server.jdbc.configuration.ConfigurationPackage#getAbstractQueryType_Period()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getPeriod <em>Period</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getPeriod <em>Period</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetPeriod()
     * @see #getPeriod()
    ...
    /**
     * Returns whether the value of the '{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getPeriod <em>Period</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setSql1(String)
     * @see org.eclipse.scada.da.server.jdbc.configuration.ConfigurationPackage#getAbstractQueryType_Sql1()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link org.eclipse.scada.da.server.jdbc.configuration.AbstractQueryType#getSql1 <em>Sql1</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
