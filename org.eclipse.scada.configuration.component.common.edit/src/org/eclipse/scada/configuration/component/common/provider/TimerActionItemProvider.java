...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.component.common.TimerAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimerActionItemProvider extends MasterComponentItemProvider
{
     ...
     * @generated
     */
    public TimerActionItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( CommonPackage.Literals.TIMER_ACTION__TARGET_ITEM );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/TimerAction" ) ); //$NON-NLS-1$
    }
    ...
    public Object getStyledText ( Object object )
    {
        ...
        {
            styledLabel.append ( getString ( "_UI_TimerAction_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_TimerAction_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
