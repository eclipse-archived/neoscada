 ...
 * @generated
 */
public class WebAdminConsoleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemStyledLabelProvider
{
    /**
    ...
    {
        return new StyledString ( getString ( "_UI_WebAdminConsole_type" ) ); //$NON-NLS-1$
    }
