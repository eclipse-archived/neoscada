 ...
 * @generated
 */
public class ConfigurationsItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemStyledLabelProvider
{
    /**
    ...
    {
        return new StyledString ( getString ( "_UI_Configurations_type" ) ); //$NON-NLS-1$
    }
