 ...
 * {@link org.eclipse.scada.configuration.infrastructure.Configurations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ConfigurationsItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
     ...
     * @generated
     */
    public ConfigurationsItemProvider ( final AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( final Object object )
    {
        if ( this.childrenFeatures == null )
        {
            ...
            this.childrenFeatures.add ( InfrastructurePackage.Literals.CONFIGURATIONS__CONFIGURATIONS );
            this.childrenFeatures.add ( InfrastructurePackage.Literals.CONFIGURATIONS__SETTINGS );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/Configurations.png" ) ); //$NON-NLS-1$
    }
