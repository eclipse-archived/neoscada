        ...
        IItemPropertySource
{
     ...
     * @generated
     */
    public ApplicationConfigurationItemProvider ( final AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( final Object object )
    {
        if ( this.childrenFeatures == null )
        {
            ...
            this.childrenFeatures.add ( InfrastructurePackage.Literals.APPLICATION_CONFIGURATION__MODULES );
        }
    ...
    {
        final String label = ( (ApplicationConfiguration)object ).getName ();
