 ...
 * @generated
 */
public class ExternalDriverPlaceholderItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ? getString ( "_UI_ExternalDriverPlaceholder_type" ) : //$NON-NLS-1$
        getString ( "_UI_ExternalDriverPlaceholder_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
