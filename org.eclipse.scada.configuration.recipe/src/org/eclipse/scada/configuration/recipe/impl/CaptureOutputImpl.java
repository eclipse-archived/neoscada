...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Capture Output</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class CaptureOutputImpl extends MinimalEObjectImpl.Container implements CaptureOutput
{
    /**
    ...
    {
        return RecipePackage.Literals.CAPTURE_OUTPUT;
    }
    ...
    public void setLocalName ( String newLocalName )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, RecipePackage.CAPTURE_OUTPUT__LOCAL_NAME, oldLocalName, localName ) );
    }
    ...
    public void setContextName ( String newContextName )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, RecipePackage.CAPTURE_OUTPUT__CONTEXT_NAME, oldContextName, contextName ) );
    }
