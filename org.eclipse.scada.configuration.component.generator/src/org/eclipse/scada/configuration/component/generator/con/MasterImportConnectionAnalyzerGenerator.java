...
public class MasterImportConnectionAnalyzerGenerator extends ConnectionAnalyzerGenerator
{

    private final MasterImportConnectionAnalyzer analyzer;

    public MasterImportConnectionAnalyzerGenerator ( final MasterImportConnectionAnalyzer analyzer )
    {
        super ( analyzer );
    ...
    {
        final String name = this.analyzer.getConnection ().getId ();
