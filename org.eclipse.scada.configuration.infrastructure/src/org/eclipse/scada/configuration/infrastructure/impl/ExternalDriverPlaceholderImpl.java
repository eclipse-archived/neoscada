 ...
 * @generated
 */
public class ExternalDriverPlaceholderImpl extends MinimalEObjectImpl.Container implements ExternalDriverPlaceholder
{
    /**
     ...
     * @generated
     */
    protected ExternalDriverPlaceholderImpl ()
    {
        super ();
    }
    ...
    {
        return InfrastructurePackage.Literals.EXTERNAL_DRIVER_PLACEHOLDER;
    }
    ...
    public void setShortDescription ( String newShortDescription )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, InfrastructurePackage.EXTERNAL_DRIVER_PLACEHOLDER__SHORT_DESCRIPTION, oldShortDescription, shortDescription ) );
    }
    ...
    public void setName ( String newName )
    {
        ...
        name = newName;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, InfrastructurePackage.EXTERNAL_DRIVER_PLACEHOLDER__NAME, oldName, name ) );
    }
    ...
    public Object eGet ( int featureID, boolean resolve, boolean coreType )
    {
        switch ( featureID )
        {
            ...
            case InfrastructurePackage.EXTERNAL_DRIVER_PLACEHOLDER__NAME:
                return getName ();
            case InfrastructurePackage.EXTERNAL_DRIVER_PLACEHOLDER__ENDPOINTS:
                return getEndpoints ();
        }
