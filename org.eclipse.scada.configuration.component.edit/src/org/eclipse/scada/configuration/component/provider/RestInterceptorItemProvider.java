        ...
        IItemPropertySource
{
    ...
    protected void addContextIdPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_RestInterceptor_contextId_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_RestInterceptor_contextId_feature", "_UI_RestInterceptor_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ComponentPackage.Literals.REST_INTERCEPTOR__CONTEXT_ID,
                        true,
                        false,
                        false,
    ...
    {
        String label = ( (RestInterceptor)object ).getContextId ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_RestInterceptor_type" ) : //$NON-NLS-1$
                getString ( "_UI_RestInterceptor_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
