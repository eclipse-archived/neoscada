...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.component.MasterImportConnectionAnalyzer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MasterImportConnectionAnalyzerItemProvider extends MasterComponentItemProvider
{
    /**
    ...
    /**
     * This returns MasterImportConnectionAnalyzer.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/MasterImportConnectionAnalyzer" ) ); //$NON-NLS-1$
    }
    ...
    public Object getStyledText ( Object object )
    {
        ...
        {
            styledLabel.append ( getString ( "_UI_MasterImportConnectionAnalyzer_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_MasterImportConnectionAnalyzer_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
