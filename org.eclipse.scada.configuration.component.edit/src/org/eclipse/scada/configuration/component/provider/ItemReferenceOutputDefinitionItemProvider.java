...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.component.ItemReferenceOutputDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemReferenceOutputDefinitionItemProvider extends OutputDefinitionItemProvider
{
     ...
     * @generated
     */
    public ItemReferenceOutputDefinitionItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    /**
     * This returns ItemReferenceOutputDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ItemReferenceOutputDefinition" ) ); //$NON-NLS-1$
    }
    ...
    public Object getStyledText ( Object object )
    {
        ...
        {
            styledLabel.append ( getString ( "_UI_ItemReferenceOutputDefinition_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_ItemReferenceOutputDefinition_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ItemReferenceOutputDefinition.class ) )
        {
            case ComponentPackage.ITEM_REFERENCE_OUTPUT_DEFINITION__ITEM_ID:
