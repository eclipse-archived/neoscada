...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.component.DataMapperService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataMapperServiceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemStyledLabelProvider
{
    /**
     ...
     * @generated
     */
    public DataMapperServiceItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ComponentPackage.Literals.DATA_MAPPER_SERVICE__DATA_MAPPER );
        }
    ...
    /**
     * This returns DataMapperService.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/DataMapperService" ) ); //$NON-NLS-1$
    }
    ...
    {
        return new StyledString ( getString ( "_UI_DataMapperService_type" ) ); //$NON-NLS-1$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( DataMapperService.class ) )
        {
