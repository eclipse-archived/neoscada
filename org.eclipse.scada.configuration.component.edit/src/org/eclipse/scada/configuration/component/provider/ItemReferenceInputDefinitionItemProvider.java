 ...
 * @generated
 */
public class ItemReferenceInputDefinitionItemProvider extends InputDefinitionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    /**
    ...
    protected void addItemIdPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ItemReferenceInputDefinition_itemId_feature" ), //$NON-NLS-1$
                        ...
                        ComponentPackage.Literals.ITEM_REFERENCE_INPUT_DEFINITION__ITEM_ID,
                        true,
                        false,
                        false,
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_ItemReferenceInputDefinition_type" ) : //$NON-NLS-1$
