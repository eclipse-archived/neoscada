 ...
 * {@link org.eclipse.scada.configuration.component.MappedSourceValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class MappedSourceValueItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
     ...
     * @generated
     */
    public MappedSourceValueItemProvider ( final AdapterFactory adapterFactory )
    {
     ...
     * @generated
     */
    protected void addMapperPropertyDescriptor ( final Object object )
    {
        this.itemPropertyDescriptors.add
                ( createItemPropertyDescriptor
                ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (),
    ...
    {
        final String label = ( (MappedSourceValue)object ).getName ();
