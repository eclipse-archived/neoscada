...
public class ValueMapperItemProvider extends ItemFeatureEntryItemProvider
	...
	protected void addSourceAttributePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ValueMapper_sourceAttribute_feature", "_UI_ValueMapper_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addTargetAttributePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ValueMapper_targetAttribute_feature", "_UI_ValueMapper_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addDataMapperPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ValueMapper_dataMapper_feature", "_UI_ValueMapper_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.VALUE_MAPPER__DATA_MAPPER, true,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ValueMapper")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ValueMapper_type") : //$NON-NLS-1$
