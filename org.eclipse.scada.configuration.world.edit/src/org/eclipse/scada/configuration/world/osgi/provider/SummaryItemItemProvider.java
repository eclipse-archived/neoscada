 ...
 * @generated
 */
public class SummaryItemItemProvider extends ItemItemProvider implements
	...
	protected void addGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_SummaryItem_group_feature", "_UI_SummaryItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.SUMMARY_ITEM__GROUP, true, false,
						true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/SummaryItem")); //$NON-NLS-1$
	}
