...
public class FormulaItemOutboundItemProvider extends ItemProviderAdapter
	...
	protected void addOutputFormulaPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_FormulaItemOutbound_outputFormula_feature", "_UI_FormulaItemOutbound_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addWriteValueVariableNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_FormulaItemOutbound_writeValueVariableName_feature", "_UI_FormulaItemOutbound_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.FORMULA_ITEM_OUTBOUND__OUTPUT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/FormulaItemOutbound")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((FormulaItemOutbound) object)
