...
public class FormulaItemInboundItemProvider extends ItemProviderAdapter
	...
	protected void addInputFormulaPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_FormulaItemInbound_inputFormula_feature", "_UI_FormulaItemInbound_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.FORMULA_ITEM_INBOUND__INPUTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/FormulaItemInbound")); //$NON-NLS-1$
	}
