 ...
 * @generated
 */
public class DataMapperItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
    /**
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ? getString ( "_UI_DataMapper_type" ) : //$NON-NLS-1$
        getString ( "_UI_DataMapper_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
