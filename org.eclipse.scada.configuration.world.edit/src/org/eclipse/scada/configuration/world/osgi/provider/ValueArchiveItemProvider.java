 ...
 * @generated
 */
public class ValueArchiveItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
    /**
    ...
    protected void addItemsPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ValueArchive_items_feature" ), //$NON-NLS-1$
                        ...
                        OsgiPackage.Literals.VALUE_ARCHIVE__ITEMS,
                        true,
                        false,
                        true,
                        null,
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_ValueArchive_type" ) : //$NON-NLS-1$
                getString ( "_UI_ValueArchive_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
