...
public class MonitorPoolProxyItemProvider extends ItemProviderAdapter implements
	...
	protected void addLocalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MonitorPoolProxy_local_feature", "_UI_MonitorPoolProxy_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MONITOR_POOL_PROXY__LOCAL, true,
	...
	protected void addRemotePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MonitorPoolProxy_remote_feature", "_UI_MonitorPoolProxy_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MONITOR_POOL_PROXY__REMOTE, true,
						false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/MonitorPoolProxy")); //$NON-NLS-1$
	}
