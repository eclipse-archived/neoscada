...
public class RestExporterItemProvider extends ItemProviderAdapter implements
	...
	protected void addItemsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_RestExporter_items_feature", "_UI_RestExporter_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.REST_EXPORTER__ITEMS, true, false,
						true, null, null, null));
	}
	...
	protected void addContextIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_RestExporter_contextId_feature", "_UI_RestExporter_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.REST_EXPORTER__CONTEXT_ID, true,
						false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.REST_EXPORTER__HIVE_PROPERTIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/RestExporter")); //$NON-NLS-1$
	}
