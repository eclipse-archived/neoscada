 ...
 * @generated
 */
public class ChangeCounterItemItemProvider
        ...
        ITableItemLabelProvider
{
    ...
    protected void addBufferPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ChangeCounterItem_buffer_feature" ), //$NON-NLS-1$
                        ...
                        OsgiPackage.Literals.CHANGE_COUNTER_ITEM__BUFFER,
                        true,
                        false,
                        true,
                        null,
    ...
    protected void addTypePropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ChangeCounterItem_type_feature" ), //$NON-NLS-1$
                        ...
                        OsgiPackage.Literals.CHANGE_COUNTER_ITEM__TYPE,
                        true,
                        false,
                        false,
    ...
    protected void addOnErrorPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ChangeCounterItem_onError_feature" ), //$NON-NLS-1$
                        ...
                        OsgiPackage.Literals.CHANGE_COUNTER_ITEM__ON_ERROR,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addValuesPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ChangeCounterItem_values_feature" ), //$NON-NLS-1$
                        ...
                        OsgiPackage.Literals.CHANGE_COUNTER_ITEM__VALUES,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_ChangeCounterItem_type" ) : //$NON-NLS-1$
