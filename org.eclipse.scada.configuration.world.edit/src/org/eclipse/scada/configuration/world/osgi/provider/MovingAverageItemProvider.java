...
public class MovingAverageItemProvider extends ItemProviderAdapter implements
	...
	protected void addItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MovingAverage_item_feature", "_UI_MovingAverage_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MOVING_AVERAGE__ITEM, true, false,
						true, null, null, null));
	}
	...
	protected void addRangePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MovingAverage_range_feature", "_UI_MovingAverage_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MOVING_AVERAGE__RANGE, true,
						false, false,
	...
	protected void addNullRangePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MovingAverage_nullRange_feature", "_UI_MovingAverage_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MOVING_AVERAGE__NULL_RANGE, true,
						false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addTriggerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MovingAverage_trigger_feature", "_UI_MovingAverage_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MOVING_AVERAGE__TRIGGER, true,
						false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addTriggerOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MovingAverage_triggerOnly_feature", "_UI_MovingAverage_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/MovingAverage")); //$NON-NLS-1$
	}
