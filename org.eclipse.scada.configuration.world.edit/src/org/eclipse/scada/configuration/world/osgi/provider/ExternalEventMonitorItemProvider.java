...
public class ExternalEventMonitorItemProvider extends ItemProviderAdapter
	...
	protected void addFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ExternalEventMonitor_filter_feature", "_UI_ExternalEventMonitor_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.EXTERNAL_EVENT_MONITOR__PROPERTIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator()
						.getImage("full/obj16/ExternalEventMonitor")); //$NON-NLS-1$
	}
