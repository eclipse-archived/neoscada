...
public class AlarmsEventsModuleItemProvider extends ItemProviderAdapter
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.ALARMS_EVENTS_MODULE__MONITOR_POOL_PROXIES);
			childrenFeatures
					.add(OsgiPackage.Literals.ALARMS_EVENTS_MODULE__EVENT_POOL_PROXIES);
			childrenFeatures
					.add(OsgiPackage.Literals.ALARMS_EVENTS_MODULE__AKN_PROXIES);
			childrenFeatures
					.add(OsgiPackage.Literals.ALARMS_EVENTS_MODULE__PULL_EVENTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/AlarmsEventsModule")); //$NON-NLS-1$
	}
