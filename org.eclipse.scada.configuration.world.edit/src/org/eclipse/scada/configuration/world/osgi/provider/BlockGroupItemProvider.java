...
public class BlockGroupItemProvider extends ItemProviderAdapter implements
	...
	protected void addHandlersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_BlockGroup_handlers_feature", "_UI_BlockGroup_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.BLOCK_GROUP__HANDLERS, true,
	...
	protected void addHierarchyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_BlockGroup_hierarchy_feature", "_UI_BlockGroup_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.BLOCK_GROUP__HIERARCHY, true,
						false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/BlockGroup")); //$NON-NLS-1$
	}
