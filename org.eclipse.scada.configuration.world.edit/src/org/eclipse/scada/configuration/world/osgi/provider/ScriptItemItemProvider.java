 ...
 * @generated
 */
public class ScriptItemItemProvider extends ItemItemProvider implements
	...
	protected void addInitScriptPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ScriptItem_initScript_feature", "_UI_ScriptItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.SCRIPT_ITEM__INIT_SCRIPT, true,
	...
	protected void addUpdateScriptPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ScriptItem_updateScript_feature", "_UI_ScriptItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.SCRIPT_ITEM__UPDATE_SCRIPT, true,
						false, false, null, null, null));
	}
	...
	protected void addScriptEnginePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ScriptItem_scriptEngine_feature", "_UI_ScriptItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.SCRIPT_ITEM__SCRIPT_ENGINE, true,
						false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.SCRIPT_ITEM__WRITE_COMMAND_SCRIPT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ScriptItem")); //$NON-NLS-1$
	}
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == OsgiPackage.Literals.SCRIPT_ITEM__INPUTS
