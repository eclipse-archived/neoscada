 ...
 * @generated
 */
public class CustomMasterServerItemProvider extends MasterServerItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
    /**
    ...
    protected void addProfilePropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_CustomMasterServer_profile_feature" ), //$NON-NLS-1$
                        ...
                        OsgiPackage.Literals.CUSTOM_MASTER_SERVER__PROFILE,
                        true,
                        false,
                        true,
                        null,
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_CustomMasterServer_type" ) : //$NON-NLS-1$
                getString ( "_UI_CustomMasterServer_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
