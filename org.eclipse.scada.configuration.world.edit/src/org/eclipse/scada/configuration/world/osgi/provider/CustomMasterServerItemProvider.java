...
public class CustomMasterServerItemProvider extends MasterServerItemProvider
	...
	protected void addProfilePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CustomMasterServer_profile_feature", "_UI_CustomMasterServer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/CustomMasterServer")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_CustomMasterServer_type") : //$NON-NLS-1$
