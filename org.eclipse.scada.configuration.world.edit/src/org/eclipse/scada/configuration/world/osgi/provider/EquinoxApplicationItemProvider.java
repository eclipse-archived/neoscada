...
import org.eclipse.scada.configuration.world.provider.ApplicationItemProvider;

/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.osgi.EquinoxApplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EquinoxApplicationItemProvider extends ApplicationItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
    /**
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ? getString ( "_UI_EquinoxApplication_type" ) : //$NON-NLS-1$
        getString ( "_UI_EquinoxApplication_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
