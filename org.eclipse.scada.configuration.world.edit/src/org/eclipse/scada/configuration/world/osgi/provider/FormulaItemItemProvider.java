 ...
 * @generated
 */
public class FormulaItemItemProvider extends ItemItemProvider implements
	...
	protected void addScriptEnginePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_FormulaItem_scriptEngine_feature", "_UI_FormulaItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.FORMULA_ITEM__SCRIPT_ENGINE, true,
						false, false,
	...
	protected void addInboundPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_FormulaItem_inbound_feature", "_UI_FormulaItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.FORMULA_ITEM__INBOUND, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.FORMULA_ITEM__INIT_SCRIPTS);
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/FormulaItem")); //$NON-NLS-1$
	}
