 ...
 * @generated
 */
public class MonitorPoolItemProvider extends ItemProviderAdapter implements
	...
	protected void addFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_MonitorPool_filter_feature", "_UI_MonitorPool_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						OsgiPackage.Literals.MONITOR_POOL__FILTER, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/MonitorPool")); //$NON-NLS-1$
	}
