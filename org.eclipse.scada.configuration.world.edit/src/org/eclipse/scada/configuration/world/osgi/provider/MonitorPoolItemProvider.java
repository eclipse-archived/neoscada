 ...
 * @generated
 */
public class MonitorPoolItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
    /**
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ? getString ( "_UI_MonitorPool_type" ) : //$NON-NLS-1$
        getString ( "_UI_MonitorPool_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
