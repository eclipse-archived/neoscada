...
public class DataAccessExporterItemProvider extends ExporterItemProvider
	...
	protected void addExportsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_DataAccessExporter_exports_feature", "_UI_DataAccessExporter_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OsgiPackage.Literals.DATA_ACCESS_EXPORTER__EXPORTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/DataAccessExporter")); //$NON-NLS-1$
	}
