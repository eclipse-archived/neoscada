...
public class BundleStartLevelItemProvider extends ItemProviderAdapter implements
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_BundleStartLevel_level_feature", "_UI_BundleStartLevel_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_BundleStartLevel_name_feature", "_UI_BundleStartLevel_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ProfilePackage.Literals.BUNDLE_START_LEVEL__NAME, true,
						false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/BundleStartLevel")); //$NON-NLS-1$
	}
