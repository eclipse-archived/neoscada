...
public class CommonDeploymentMechanismItemProvider extends ItemProviderAdapter
	...
	protected void addMaintainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CommonDeploymentMechanism_maintainer_feature", "_UI_CommonDeploymentMechanism_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(DeploymentPackage.Literals.COMMON_DEPLOYMENT_MECHANISM__CHANGES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/CommonDeploymentMechanism")); //$NON-NLS-1$
	}
