 ...
 * @generated
 */
public class SimpleNodeMappingEntryItemProvider extends ItemProviderAdapter
	...
	protected void addFromHostNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_SimpleNodeMappingEntry_fromHostName_feature", "_UI_SimpleNodeMappingEntry_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addToHostNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_SimpleNodeMappingEntry_toHostName_feature", "_UI_SimpleNodeMappingEntry_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/SimpleNodeMappingEntry")); //$NON-NLS-1$
	}
