...
public class NodeMappingsItemProvider extends ItemProviderAdapter implements
	...
	protected void addFallbackModePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_NodeMappings_fallbackMode_feature", "_UI_NodeMappings_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(DeploymentPackage.Literals.NODE_MAPPINGS__ENTRIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/NodeMappings")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		FallbackNodeMappingMode labelValue = ((NodeMappings) object)
				.getFallbackMode();
