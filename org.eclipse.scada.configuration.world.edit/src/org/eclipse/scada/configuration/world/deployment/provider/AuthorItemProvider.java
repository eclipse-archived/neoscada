...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.deployment.Author} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AuthorItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Author_name_feature", "_UI_Author_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						DeploymentPackage.Literals.AUTHOR__NAME, true, false,
	...
	protected void addEmailPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Author_email_feature", "_UI_Author_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						DeploymentPackage.Literals.AUTHOR__EMAIL, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Author")); //$NON-NLS-1$
	}
