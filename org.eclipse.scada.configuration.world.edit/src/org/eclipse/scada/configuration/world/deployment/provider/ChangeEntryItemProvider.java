 ...
 * {@link org.eclipse.scada.configuration.world.deployment.ChangeEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class ChangeEntryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
     ...
     * @generated
     */
    public ChangeEntryItemProvider ( final AdapterFactory adapterFactory )
    {
     ...
     * @generated
     */
    protected void addAuthorPropertyDescriptor ( final Object object )
    {
        this.itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_ChangeEntry_author_feature" ), //$NON-NLS-1$
     ...
     * @generated
     */
    protected void addDatePropertyDescriptor ( final Object object )
    {
        this.itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_ChangeEntry_date_feature" ), //$NON-NLS-1$
    ...
    {
        this.itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_ChangeEntry_description_feature" ), //$NON-NLS-1$
    ...
    {
        this.itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_ChangeEntry_version_feature" ), //$NON-NLS-1$
    ...
    {
        final Date labelValue = ( (ChangeEntry)object ).getDate ();
