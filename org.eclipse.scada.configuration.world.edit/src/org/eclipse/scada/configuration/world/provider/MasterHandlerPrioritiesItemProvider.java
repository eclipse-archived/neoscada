...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.MasterHandlerPriorities} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MasterHandlerPrioritiesItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, IItemStyledLabelProvider
{
    /**
     ...
     * @generated
     */
    public MasterHandlerPrioritiesItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( WorldPackage.Literals.MASTER_HANDLER_PRIORITIES__RULES );
        }
    ...
    /**
     * This returns MasterHandlerPriorities.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/MasterHandlerPriorities" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (MasterHandlerPriorities)object ).getName ();
        StyledString styledLabel = new StyledString ();
        if ( label == null || label.length () == 0 )
        {
            styledLabel.append ( getString ( "_UI_MasterHandlerPriorities_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_MasterHandlerPriorities_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( MasterHandlerPriorities.class ) )
        {
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add ( createChildParameter ( WorldPackage.Literals.MASTER_HANDLER_PRIORITIES__RULES, WorldFactory.eINSTANCE.createHandlerPriorityRule () ) );
    }
