...
public class EndpointItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider
{
    ...
    public String getText ( final Object object )
    {
        ...
        {
            return String.format ( "%s %s - %s", getString ( "_UI_Endpoint_type" ), endpoint.getName (), endpoint.getPortNumber () );
        }
        else
        {
            return getString ( "_UI_Endpoint_type" ) + " " + endpoint.getPortNumber (); //$NON-NLS-1$ //$NON-NLS-2$    
        }
    }
