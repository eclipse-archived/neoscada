...
public class EndpointItemProvider extends ItemProviderAdapter implements
	...
	protected void addPortNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Endpoint_portNumber_feature", "_UI_Endpoint_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						WorldPackage.Literals.ENDPOINT__PORT_NUMBER, true,
						false, false,
	...
	public String getText(final Object object) {
		...
		if (endpoint.getName() != null) {
			return String.format("%s %s - %s", getString("_UI_Endpoint_type"),
					endpoint.getName(), endpoint.getPortNumber());
		} else {
