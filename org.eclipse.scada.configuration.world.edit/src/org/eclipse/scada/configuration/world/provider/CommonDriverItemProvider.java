 ...
 * @generated
 */
public class CommonDriverItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_CommonDriver_endpoints_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CommonDriver_endpoints_feature", "_UI_CommonDriver_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						WorldPackage.Literals.COMMON_DRIVER__ENDPOINTS, true,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/CommonDriver")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				WorldPackage.Literals.COMMON_DRIVER__PASSWORD,
