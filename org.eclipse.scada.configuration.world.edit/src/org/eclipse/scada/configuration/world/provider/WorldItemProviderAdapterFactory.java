...
public class WorldItemProviderAdapterFactory extends WorldAdapterFactory
	...
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(
			WorldEditPlugin.INSTANCE, WorldPackage.eNS_URI);
	...
	public Adapter createHandlerPriorityRuleAdapter() {
		if (handlerPriorityRuleItemProvider == null) {
			handlerPriorityRuleItemProvider = new HandlerPriorityRuleItemProvider(
					this);
		}
	...
	public Adapter createMasterHandlerPrioritiesAdapter() {
		if (masterHandlerPrioritiesItemProvider == null) {
			masterHandlerPrioritiesItemProvider = new MasterHandlerPrioritiesItemProvider(
					this);
		}
