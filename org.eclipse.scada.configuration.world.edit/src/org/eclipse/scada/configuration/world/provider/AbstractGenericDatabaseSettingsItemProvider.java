 ...
 * @generated
 */
public class AbstractGenericDatabaseSettingsItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, IItemStyledLabelProvider
{
    /**
    ...
    public Object getStyledText ( Object object )
    {
        ...
        {
            styledLabel.append ( getString ( "_UI_AbstractGenericDatabaseSettings_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_AbstractGenericDatabaseSettings_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
