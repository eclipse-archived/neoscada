...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.ContainedServiceBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainedServiceBindingItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, IItemStyledLabelProvider
{
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( WorldPackage.Literals.CONTAINED_SERVICE_BINDING__SERVICE );
        }
    ...
    /**
     * This returns ContainedServiceBinding.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ContainedServiceBinding" ) ); //$NON-NLS-1$
    }
    ...
    {
        return new StyledString ( getString ( "_UI_ContainedServiceBinding_type" ) ); //$NON-NLS-1$
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( ContainedServiceBinding.class ) )
        {
