 ...
 * @generated
 */
public class ApplicationNodeItemProvider extends NodeItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(WorldPackage.Literals.APPLICATION_NODE__APPLICATIONS);
			childrenFeatures
					.add(WorldPackage.Literals.APPLICATION_NODE__SERVICES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ApplicationNode")); //$NON-NLS-1$
	}
