 ...
 * 
 */
package org.eclipse.scada.configuration.world.setup.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.world.setup.OperatingSystemDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatingSystemDescriptorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, ITableItemLabelProvider, IItemStyledLabelProvider
{
    /**
     ...
     * @generated
     */
    public OperatingSystemDescriptorItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( SetupPackage.Literals.OPERATING_SYSTEM_DESCRIPTOR__PROPERTIES );
        }
    ...
    /**
     * This returns OperatingSystemDescriptor.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/OperatingSystemDescriptor" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (OperatingSystemDescriptor)object ).getLabel ();
        StyledString styledLabel = new StyledString ();
        if ( label == null || label.length () == 0 )
        {
            styledLabel.append ( getString ( "_UI_OperatingSystemDescriptor_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_OperatingSystemDescriptor_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( OperatingSystemDescriptor.class ) )
        {
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add ( createChildParameter ( SetupPackage.Literals.OPERATING_SYSTEM_DESCRIPTOR__PROPERTIES, WorldFactory.eINSTANCE.createPropertyEntry () ) );
    }
