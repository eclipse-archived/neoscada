...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.da.server.jdbc.configuration.UpdateType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
    ...
    protected void addSqlPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_UpdateType_sql_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_UpdateType_sql_feature", "_UI_UpdateType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ConfigurationPackage.Literals.UPDATE_TYPE__SQL,
                        true,
                        false,
                        false,
    ...
    protected void addSql1PropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_UpdateType_sql1_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_UpdateType_sql1_feature", "_UI_UpdateType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ConfigurationPackage.Literals.UPDATE_TYPE__SQL1,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ConfigurationPackage.Literals.UPDATE_TYPE__MAPPING );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/UpdateType" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (UpdateType)object ).getId ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_UpdateType_type" ) : //$NON-NLS-1$
                getString ( "_UI_UpdateType_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
