...
import org.eclipse.scada.configuration.modbus.util.ModbusResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>modbus</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getResourceFactoryRegistry ().getExtensionToFactoryMap ().put
                ( Resource.Factory.Registry.DEFAULT_EXTENSION,
                        new ModbusResourceFactoryImpl () );

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry ().put
                ( ModbusPackage.eNS_URI,
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.modbusConfiguration" ) ); //$NON-NLS-1$
                ModbusDevice root = ModbusFactory.eINSTANCE.createModbusDevice ();
