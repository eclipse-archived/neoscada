...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.globalization.MonitorPoolImport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MonitorPoolImportItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemStyledLabelProvider
{
    /**
     ...
     * @generated
     */
    public MonitorPoolImportItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    {
        itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_MonitorPoolImport_localName_feature" ), //$NON-NLS-1$
                getString ( "_UI_PropertyDescriptor_description", "_UI_MonitorPoolImport_localName_feature", "_UI_MonitorPoolImport_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                GlobalizePackage.Literals.MONITOR_POOL_IMPORT__LOCAL_NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null ) );
    }
    ...
    {
        itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_MonitorPoolImport_includeLocal_feature" ), //$NON-NLS-1$
                getString ( "_UI_PropertyDescriptor_description", "_UI_MonitorPoolImport_includeLocal_feature", "_UI_MonitorPoolImport_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                GlobalizePackage.Literals.MONITOR_POOL_IMPORT__INCLUDE_LOCAL, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null ) );
    }

    /**
     * This returns MonitorPoolImport.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/MonitorPoolImport" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (MonitorPoolImport)object ).getName ();
        StyledString styledLabel = new StyledString ();
        if ( label == null || label.length () == 0 )
        {
            styledLabel.append ( getString ( "_UI_MonitorPoolImport_type" ), StyledString.Style.QUALIFIER_STYLER ); //$NON-NLS-1$
        }
        else
        {
            styledLabel.append ( getString ( "_UI_MonitorPoolImport_type" ), StyledString.Style.QUALIFIER_STYLER ).append ( " " + label ); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
    ...
    public void notifyChanged ( Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( MonitorPoolImport.class ) )
        {
