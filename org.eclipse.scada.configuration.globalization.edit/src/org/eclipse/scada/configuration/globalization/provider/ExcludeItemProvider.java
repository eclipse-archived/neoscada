...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.configuration.globalization.Exclude} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExcludeItemProvider extends PatternFilterItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/Exclude" ) ); //$NON-NLS-1$
    }
