...
public class ItemExportImpl extends MinimalEObjectImpl.Container implements
			...
			if (item != oldItem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.ITEM_EXPORT__ITEM, oldItem, item));
			}
		}
		return item;
	}
	...
	public void setExportName(String newExportName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ITEM_EXPORT__EXPORT_NAME, oldExportName,
					exportName));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.ITEM_EXPORT__ITEM:
			return item != null;
		case OsgiPackage.ITEM_EXPORT__EXPORT_NAME:
			return EXPORT_NAME_EDEFAULT == null ? exportName != null
					: !EXPORT_NAME_EDEFAULT.equals(exportName);
		}
