 ...
 * @generated
 */
public class MarkersImpl extends MinimalEObjectImpl.Container implements
		Markers {
	/**
	...
	public EList<MarkerGroup> getMarkerGroups() {
		if (markerGroups == null) {
			markerGroups = new EObjectContainmentEList.Resolving<MarkerGroup>(
					MarkerGroup.class, this, OsgiPackage.MARKERS__MARKER_GROUPS);
		}
		return markerGroups;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case OsgiPackage.MARKERS__MARKER_GROUPS:
			return ((InternalEList<?>) getMarkerGroups()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.MARKERS__MARKER_GROUPS:
			...
			getMarkerGroups().addAll(
					(Collection<? extends MarkerGroup>) newValue);
			return;
		}
