...
public class AverageImpl extends MinimalEObjectImpl.Container implements
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.AVERAGE__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.AVERAGE__NAME, oldName, name));
	}
	...
	public void setSourcesRequired(String newSourcesRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.AVERAGE__SOURCES_REQUIRED, oldSourcesRequired,
					sourcesRequired));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.AVERAGE__SOURCES_REQUIRED:
			return SOURCES_REQUIRED_EDEFAULT == null ? sourcesRequired != null
					: !SOURCES_REQUIRED_EDEFAULT.equals(sourcesRequired);
		}
