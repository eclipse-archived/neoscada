...
public abstract class AbstractEventStorageJdbcImpl extends
	...
	public EList<PropertyEntry> getJdbcProperties() {
		if (jdbcProperties == null) {
			jdbcProperties = new EObjectContainmentEList.Resolving<PropertyEntry>(
					...
					OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__JDBC_PROPERTIES);
		}
	...
	public void setSchema(String newSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__SCHEMA, oldSchema,
					schema));
	}
	...
	public void setInstanceName(String newInstanceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__INSTANCE_NAME,
	...
	public void setEnableReplication(boolean newEnableReplication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__ENABLE_REPLICATION,
					oldEnableReplication, enableReplication));
	}
	...
	public void setArchiveDays(Integer newArchiveDays) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__ARCHIVE_DAYS,
	...
	public void setCleanupPeriodSeconds(Integer newCleanupPeriodSeconds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__CLEANUP_PERIOD_SECONDS,
					oldCleanupPeriodSeconds, cleanupPeriodSeconds));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__ARCHIVE_DAYS:
			return ARCHIVE_DAYS_EDEFAULT == null ? archiveDays != null
					: !ARCHIVE_DAYS_EDEFAULT.equals(archiveDays);
		case OsgiPackage.ABSTRACT_EVENT_STORAGE_JDBC__CLEANUP_PERIOD_SECONDS:
			return CLEANUP_PERIOD_SECONDS_EDEFAULT == null ? cleanupPeriodSeconds != null
					: !CLEANUP_PERIOD_SECONDS_EDEFAULT
							.equals(cleanupPeriodSeconds);
		}
