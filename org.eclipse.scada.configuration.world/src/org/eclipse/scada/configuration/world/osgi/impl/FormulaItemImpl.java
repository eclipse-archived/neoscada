...
public class FormulaItemImpl extends ItemImpl implements FormulaItem {
	...
	public void setScriptEngine(String newScriptEngine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.FORMULA_ITEM__SCRIPT_ENGINE, oldScriptEngine,
					scriptEngine));
	}
	...
	public EList<CodeFragment> getInitScripts() {
		if (initScripts == null) {
			initScripts = new EObjectContainmentEList.Resolving<CodeFragment>(
					CodeFragment.class, this,
					OsgiPackage.FORMULA_ITEM__INIT_SCRIPTS);
		}
		return initScripts;
	}
	...
	public FormulaItemOutbound getOutbound() {
		if (outbound != null && outbound.eIsProxy()) {
			...
			if (outbound != oldOutbound) {
				...
				NotificationChain msgs = oldOutbound.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- OsgiPackage.FORMULA_ITEM__OUTBOUND, null,
						null);
				if (newOutbound.eInternalContainer() == null) {
					msgs = newOutbound.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- OsgiPackage.FORMULA_ITEM__OUTBOUND, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.FORMULA_ITEM__OUTBOUND, oldOutbound,
							outbound));
			}
		}
		return outbound;
	...
	public NotificationChain basicSetOutbound(FormulaItemOutbound newOutbound,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, OsgiPackage.FORMULA_ITEM__OUTBOUND,
	...
	public void setOutbound(FormulaItemOutbound newOutbound) {
		if (newOutbound != outbound) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.FORMULA_ITEM__OUTBOUND, newOutbound,
					newOutbound));
	}
	...
	public FormulaItemInbound getInbound() {
		if (inbound != null && inbound.eIsProxy()) {
			...
			if (inbound != oldInbound) {
				...
				NotificationChain msgs = oldInbound
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- OsgiPackage.FORMULA_ITEM__INBOUND, null, null);
				if (newInbound.eInternalContainer() == null) {
					msgs = newInbound.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- OsgiPackage.FORMULA_ITEM__INBOUND, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.FORMULA_ITEM__INBOUND, oldInbound,
							inbound));
			}
		}
		return inbound;
	...
	public NotificationChain basicSetInbound(FormulaItemInbound newInbound,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, OsgiPackage.FORMULA_ITEM__INBOUND,
	...
	public void setInbound(FormulaItemInbound newInbound) {
		if (newInbound != inbound) {
			NotificationChain msgs = null;
			if (inbound != null)
				msgs = ((InternalEObject) inbound)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- OsgiPackage.FORMULA_ITEM__INBOUND, null, msgs);
			if (newInbound != null)
				msgs = ((InternalEObject) newInbound)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.FORMULA_ITEM__INBOUND, newInbound, newInbound));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case OsgiPackage.FORMULA_ITEM__INIT_SCRIPTS:
			return ((InternalEList<?>) getInitScripts()).basicRemove(otherEnd,
					msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.FORMULA_ITEM__INIT_SCRIPTS:
			...
			getInitScripts().addAll(
					(Collection<? extends CodeFragment>) newValue);
			return;
		case OsgiPackage.FORMULA_ITEM__OUTBOUND:
