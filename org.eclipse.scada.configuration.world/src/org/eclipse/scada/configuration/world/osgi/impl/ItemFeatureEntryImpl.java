 ...
 * @generated
 */
public abstract class ItemFeatureEntryImpl extends MinimalEObjectImpl.Container
		implements ItemFeatureEntry {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ITEM_FEATURE_ENTRY__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetItem(Item newItem, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newItem,
				OsgiPackage.ITEM_FEATURE_ENTRY__ITEM, msgs);
		return msgs;
	}
	...
	public void setItem(Item newItem) {
		if (newItem != eInternalContainer()
				|| (eContainerFeatureID() != OsgiPackage.ITEM_FEATURE_ENTRY__ITEM && newItem != null)) {
			...
			if (newItem != null)
				msgs = ((InternalEObject) newItem).eInverseAdd(this,
						OsgiPackage.ITEM__ITEM_FEATURES, Item.class, msgs);
			msgs = basicSetItem(newItem, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ITEM_FEATURE_ENTRY__ITEM, newItem, newItem));
	}
