...
public class FormulaItemOutboundImpl extends MinimalEObjectImpl.Container
	...
	public TypedItemReference getOutput() {
		if (output != null && output.eIsProxy()) {
			...
			if (output != oldOutput) {
				...
				NotificationChain msgs = oldOutput.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT,
						null, null);
				if (newOutput.eInternalContainer() == null) {
					msgs = newOutput.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT, null,
							msgs);
				}
				if (msgs != null)
					msgs.dispatch();
	...
	public NotificationChain basicSetOutput(TypedItemReference newOutput,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT, oldOutput,
					newOutput);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOutput(TypedItemReference newOutput) {
		if (newOutput != output) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT, newOutput,
					newOutput));
	}
	...
	public void setOutputFormula(String newOutputFormula) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT_FORMULA,
					oldOutputFormula, outputFormula));
	}
	...
	public void setWriteValueVariableName(String newWriteValueVariableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					OsgiPackage.FORMULA_ITEM_OUTBOUND__WRITE_VALUE_VARIABLE_NAME,
					oldWriteValueVariableName, writeValueVariableName));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT:
			return output != null;
		case OsgiPackage.FORMULA_ITEM_OUTBOUND__OUTPUT_FORMULA:
			return OUTPUT_FORMULA_EDEFAULT == null ? outputFormula != null
					: !OUTPUT_FORMULA_EDEFAULT.equals(outputFormula);
		case OsgiPackage.FORMULA_ITEM_OUTBOUND__WRITE_VALUE_VARIABLE_NAME:
			return WRITE_VALUE_VARIABLE_NAME_EDEFAULT == null ? writeValueVariableName != null
					: !WRITE_VALUE_VARIABLE_NAME_EDEFAULT
							.equals(writeValueVariableName);
		}
