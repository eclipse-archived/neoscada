...
public class AttributesSummaryImpl extends ItemFeatureEntryImpl implements
	...
	public EList<String> getAttributes() {
		if (attributes == null) {
			attributes = new EDataTypeUniqueEList<String>(String.class, this,
					OsgiPackage.ATTRIBUTES_SUMMARY__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public void setOutputPrefix(String newOutputPrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ATTRIBUTES_SUMMARY__OUTPUT_PREFIX,
					oldOutputPrefix, outputPrefix));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.ATTRIBUTES_SUMMARY__OUTPUT_PREFIX:
			return OUTPUT_PREFIX_EDEFAULT == null ? outputPrefix != null
					: !OUTPUT_PREFIX_EDEFAULT.equals(outputPrefix);
		}
