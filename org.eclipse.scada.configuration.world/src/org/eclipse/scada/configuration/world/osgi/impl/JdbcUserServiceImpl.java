...
public class JdbcUserServiceImpl extends MinimalEObjectImpl.Container implements JdbcUserService
{
    ...
    public void setShortDescription ( String newShortDescription )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__SHORT_DESCRIPTION, oldShortDescription, shortDescription ) );
    }
    ...
    public void setName ( String newName )
    {
        ...
        name = newName;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__NAME, oldName, name ) );
    }
    ...
    public EList<PropertyEntry> getJdbcPropeties ()
    {
        ...
        {
            jdbcPropeties = new EObjectContainmentEList.Resolving<PropertyEntry> ( PropertyEntry.class, this, OsgiPackage.JDBC_USER_SERVICE__JDBC_PROPETIES );
        }
    ...
    public void setJdbcDriver ( String newJdbcDriver )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__JDBC_DRIVER, oldJdbcDriver, jdbcDriver ) );
    }
    ...
    public void setAuthorative ( boolean newAuthorative )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__AUTHORATIVE, oldAuthorative, authorative ) );
    }
    ...
    public void setFindUserSql ( String newFindUserSql )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__FIND_USER_SQL, oldFindUserSql, findUserSql ) );
    }
    ...
    public void setFindRolesForUserSql ( String newFindRolesForUserSql )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__FIND_ROLES_FOR_USER_SQL, oldFindRolesForUserSql, findRolesForUserSql ) );
    }
    ...
    public void setUpdatePasswordSql ( String newUpdatePasswordSql )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__UPDATE_PASSWORD_SQL, oldUpdatePasswordSql, updatePasswordSql ) );
    }
    ...
    public void setUserIdColumnName ( String newUserIdColumnName )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__USER_ID_COLUMN_NAME, oldUserIdColumnName, userIdColumnName ) );
    }
    ...
    public void setPasswordColumnName ( String newPasswordColumnName )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__PASSWORD_COLUMN_NAME, oldPasswordColumnName, passwordColumnName ) );
    }
    ...
    public void setPasswordType ( PasswordType newPasswordType )
    {
        ...
        passwordType = newPasswordType == null ? PASSWORD_TYPE_EDEFAULT : newPasswordType;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.JDBC_USER_SERVICE__PASSWORD_TYPE, oldPasswordType, passwordType ) );
    }
    ...
    public NotificationChain eInverseRemove ( InternalEObject otherEnd, int featureID, NotificationChain msgs )
    {
        switch ( featureID )
        {
            case OsgiPackage.JDBC_USER_SERVICE__JDBC_PROPETIES:
                return ( (InternalEList<?>)getJdbcPropeties () ).basicRemove ( otherEnd, msgs );
        }
    ...
    public void eSet ( int featureID, Object newValue )
    {
        switch ( featureID )
        {
            ...
            case OsgiPackage.JDBC_USER_SERVICE__JDBC_PROPETIES:
                ...
                getJdbcPropeties ().addAll ( (Collection<? extends PropertyEntry>)newValue );
                return;
            case OsgiPackage.JDBC_USER_SERVICE__JDBC_DRIVER:
    ...
    public boolean eIsSet ( int featureID )
    {
        switch ( featureID )
        {
            ...
            case OsgiPackage.JDBC_USER_SERVICE__FIND_USER_SQL:
                return FIND_USER_SQL_EDEFAULT == null ? findUserSql != null : !FIND_USER_SQL_EDEFAULT.equals ( findUserSql );
            case OsgiPackage.JDBC_USER_SERVICE__FIND_ROLES_FOR_USER_SQL:
                return FIND_ROLES_FOR_USER_SQL_EDEFAULT == null ? findRolesForUserSql != null : !FIND_ROLES_FOR_USER_SQL_EDEFAULT.equals ( findRolesForUserSql );
            case OsgiPackage.JDBC_USER_SERVICE__UPDATE_PASSWORD_SQL:
                return UPDATE_PASSWORD_SQL_EDEFAULT == null ? updatePasswordSql != null : !UPDATE_PASSWORD_SQL_EDEFAULT.equals ( updatePasswordSql );
            case OsgiPackage.JDBC_USER_SERVICE__USER_ID_COLUMN_NAME:
                return USER_ID_COLUMN_NAME_EDEFAULT == null ? userIdColumnName != null : !USER_ID_COLUMN_NAME_EDEFAULT.equals ( userIdColumnName );
            case OsgiPackage.JDBC_USER_SERVICE__PASSWORD_COLUMN_NAME:
                return PASSWORD_COLUMN_NAME_EDEFAULT == null ? passwordColumnName != null : !PASSWORD_COLUMN_NAME_EDEFAULT.equals ( passwordColumnName );
            case OsgiPackage.JDBC_USER_SERVICE__PASSWORD_TYPE:
