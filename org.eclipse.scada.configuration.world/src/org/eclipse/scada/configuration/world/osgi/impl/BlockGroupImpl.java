...
public class BlockGroupImpl extends MinimalEObjectImpl.Container implements
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BLOCK_GROUP__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BLOCK_GROUP__NAME, oldName, name));
	}
	...
	public EList<BlockHandler> getHandlers() {
		if (handlers == null) {
			handlers = new EObjectWithInverseResolvingEList<BlockHandler>(
					BlockHandler.class, this,
					OsgiPackage.BLOCK_GROUP__HANDLERS,
					OsgiPackage.BLOCK_HANDLER__GROUP);
		}
		return handlers;
	}
	...
	public EList<String> getHierarchy() {
		if (hierarchy == null) {
			hierarchy = new EDataTypeUniqueEList<String>(String.class, this,
					OsgiPackage.BLOCK_GROUP__HIERARCHY);
		}
		return hierarchy;
	}
