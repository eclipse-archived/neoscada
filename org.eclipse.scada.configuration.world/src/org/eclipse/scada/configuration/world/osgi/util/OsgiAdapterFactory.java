...
public class OsgiAdapterFactory extends AdapterFactoryImpl {
	...
	protected OsgiSwitch<Adapter> modelSwitch = new OsgiSwitch<Adapter>() {
		...
		@Override
		public Adapter caseStaticExternalEventFilter(
				StaticExternalEventFilter object) {
			return createStaticExternalEventFilterAdapter();
		}

		@Override
		public Adapter caseSimpleExternalEventFilter(
				SimpleExternalEventFilter object) {
		...
		@Override
		public Adapter caseWeakReferenceDataSourceItem(
				WeakReferenceDataSourceItem object) {
		...
		@Override
		public Adapter caseDefaultValueArchiveServer(
				DefaultValueArchiveServer object) {
		...
		@Override
		public Adapter caseConfigurationAdministratorExporter(
		...
		@Override
		public Adapter caseAbstractEventStorageJdbc(
				AbstractEventStorageJdbc object) {
			return createAbstractEventStorageJdbcAdapter();
		}

		@Override
		public Adapter caseApplicationConfiguration(
		...
		@Override
		public Adapter caseIndependentConfiguration(
				IndependentConfiguration object) {
