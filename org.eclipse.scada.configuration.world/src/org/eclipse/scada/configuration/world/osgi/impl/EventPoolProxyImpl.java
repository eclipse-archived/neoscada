...
public class EventPoolProxyImpl extends MinimalEObjectImpl.Container implements
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_POOL_PROXY__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_POOL_PROXY__NAME, oldName, name));
	}
	...
	public EList<EventPool> getLocal() {
		if (local == null) {
			local = new EObjectResolvingEList<EventPool>(EventPool.class, this,
					OsgiPackage.EVENT_POOL_PROXY__LOCAL);
		}
		return local;
	}
	...
	public EList<EventPool> getRemote() {
		if (remote == null) {
			remote = new EObjectResolvingEList<EventPool>(EventPool.class,
					this, OsgiPackage.EVENT_POOL_PROXY__REMOTE);
		}
		return remote;
	}
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_POOL_PROXY__SIZE, oldSize, size));
	}
