...
public class MovingAverageItemImpl extends ItemImpl implements
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.MOVING_AVERAGE_ITEM__SOURCE, oldSource,
							source));
			}
		}
		return source;
	...
	public void setSource(MovingAverage newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE_ITEM__SOURCE, oldSource, source));
	}
	...
	public void setType(MovingAverageReferenceType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE_ITEM__TYPE, oldType, type));
	}
