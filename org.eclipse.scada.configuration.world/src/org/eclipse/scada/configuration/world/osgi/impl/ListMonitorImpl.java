...
public class ListMonitorImpl extends ItemFeatureEntryImpl implements
	 ...
	 * @ordered
	 */
	protected static final Severity DEFAULT_SEVERITY_EDEFAULT = (Severity) OsgiFactory.eINSTANCE
			.createFromString(OsgiPackage.eINSTANCE.getSeverity(), "ALARM"); //$NON-NLS-1$
	...
	public void setMessage(String newMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LIST_MONITOR__MESSAGE, oldMessage, message));
	}
	...
	public void setMessageAttribute(String newMessageAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LIST_MONITOR__MESSAGE_ATTRIBUTE,
					oldMessageAttribute, messageAttribute));
	}
	...
	public void setDefaultAck(boolean newDefaultAck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LIST_MONITOR__DEFAULT_ACK, oldDefaultAck,
					defaultAck));
	}
	...
	public void setDefaultSeverity(Severity newDefaultSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LIST_MONITOR__DEFAULT_SEVERITY,
					oldDefaultSeverity, defaultSeverity));
	}
	...
	public void setMonitorType(String newMonitorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LIST_MONITOR__MONITOR_TYPE, oldMonitorType,
					monitorType));
	}
	...
	public void setDemotePrefix(String newDemotePrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LIST_MONITOR__DEMOTE_PREFIX, oldDemotePrefix,
					demotePrefix));
	}
	...
	public EList<ListMonitorEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList.Resolving<ListMonitorEntry>(
					ListMonitorEntry.class, this,
					OsgiPackage.LIST_MONITOR__ENTRIES);
		}
		return entries;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.LIST_MONITOR__ENTRIES:
			getEntries().clear();
			getEntries().addAll(
					(Collection<? extends ListMonitorEntry>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.LIST_MONITOR__MESSAGE_ATTRIBUTE:
			return MESSAGE_ATTRIBUTE_EDEFAULT == null ? messageAttribute != null
					: !MESSAGE_ATTRIBUTE_EDEFAULT.equals(messageAttribute);
		case OsgiPackage.LIST_MONITOR__DEFAULT_ACK:
			return defaultAck != DEFAULT_ACK_EDEFAULT;
		case OsgiPackage.LIST_MONITOR__DEFAULT_SEVERITY:
			return DEFAULT_SEVERITY_EDEFAULT == null ? defaultSeverity != null
					: !DEFAULT_SEVERITY_EDEFAULT.equals(defaultSeverity);
		case OsgiPackage.LIST_MONITOR__MONITOR_TYPE:
			return MONITOR_TYPE_EDEFAULT == null ? monitorType != null
					: !MONITOR_TYPE_EDEFAULT.equals(monitorType);
		case OsgiPackage.LIST_MONITOR__DEMOTE_PREFIX:
			return DEMOTE_PREFIX_EDEFAULT == null ? demotePrefix != null
					: !DEMOTE_PREFIX_EDEFAULT.equals(demotePrefix);
		case OsgiPackage.LIST_MONITOR__ENTRIES:
