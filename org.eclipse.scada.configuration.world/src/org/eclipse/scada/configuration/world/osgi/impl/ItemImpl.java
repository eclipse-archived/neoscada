...
public abstract class ItemImpl extends MinimalEObjectImpl.Container implements
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ITEM__NAME, oldName, name));
	}
	...
	public ItemInformation getInformation() {
		if (information != null && information.eIsProxy()) {
			...
			if (information != oldInformation) {
				...
				NotificationChain msgs = oldInformation.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - OsgiPackage.ITEM__INFORMATION,
						null, null);
				if (newInformation.eInternalContainer() == null) {
					msgs = newInformation
							.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
									- OsgiPackage.ITEM__INFORMATION, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.ITEM__INFORMATION, oldInformation,
							information));
			}
		}
		return information;
	...
	public NotificationChain basicSetInformation(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, OsgiPackage.ITEM__INFORMATION,
	...
	public void setInformation(ItemInformation newInformation) {
		if (newInformation != information) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.ITEM__INFORMATION, newInformation,
					newInformation));
	}
	...
	public EList<ItemFeatureEntry> getItemFeatures() {
		if (itemFeatures == null) {
			itemFeatures = new EObjectContainmentWithInverseEList.Resolving<ItemFeatureEntry>(
					ItemFeatureEntry.class, this,
					OsgiPackage.ITEM__ITEM_FEATURES,
					OsgiPackage.ITEM_FEATURE_ENTRY__ITEM);
		}
		return itemFeatures;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case OsgiPackage.ITEM__ITEM_FEATURES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getItemFeatures())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case OsgiPackage.ITEM__ITEM_FEATURES:
			return ((InternalEList<?>) getItemFeatures()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.ITEM__ITEM_FEATURES:
			...
			getItemFeatures().addAll(
					(Collection<? extends ItemFeatureEntry>) newValue);
			return;
		}
