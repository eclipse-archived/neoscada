...
public class ProfilePackageImpl extends EPackageImpl implements ProfilePackage {
	...
	public static ProfilePackage init() {
		...
		ProfilePackageImpl theProfilePackage = (ProfilePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ProfilePackageImpl ? EPackage.Registry.INSTANCE
		...
		EPackage.Registry.INSTANCE.put(ProfilePackage.eNS_URI,
				theProfilePackage);
	...
	public EAttribute getSystemProperty_Key() {
		return (EAttribute) systemPropertyEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getBundleStartLevel_Level() {
		return (EAttribute) bundleStartLevelEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(
				profileEClass,
				Profile.class,
				"Profile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getProfile_InstallationUnits(),
				ecorePackage.getEString(),
				"installationUnits", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getProfile_JvmArgument(),
				ecorePackage.getEString(),
				"jvmArgument", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getProfile_Start(),
				this.getStartBundle(),
				null,
				"start", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		getProfile_Start().getEKeys().add(this.getStartBundle_Name());
		initEReference(
				getProfile_Setbsl(),
				this.getBundleStartLevel(),
				null,
				"setbsl", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getProfile_Property(),
				this.getSystemProperty(),
				null,
				"property", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getProfile_Notes(),
				ecorePackage.getEString(),
				"notes", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getProfile_Profile(),
				this.getSubProfile(),
				null,
				"profile", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getProfile_Includes(),
				this.getProfile(),
				null,
				"includes", null, 0, -1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getProfile_Name(),
				ecorePackage.getEString(),
				"name", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getProfile_Description(),
				ecorePackage.getEString(),
				"description", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				startBundleEClass,
				StartBundle.class,
				"StartBundle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getStartBundle_Name(),
				ecorePackage.getEString(),
				"name", null, 1, 1, StartBundle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				systemPropertyEClass,
				SystemProperty.class,
				"SystemProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getSystemProperty_Key(),
				ecorePackage.getEString(),
				"key", null, 1, 1, SystemProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getSystemProperty_Value(),
				ecorePackage.getEString(),
				"value", null, 0, 1, SystemProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getSystemProperty_Eval(),
				ecorePackage.getEBoolean(),
				"eval", "false", 0, 1, SystemProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$

		initEClass(
				subProfileEClass,
				SubProfile.class,
				"SubProfile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getSubProfile_Property(),
				this.getSystemProperty(),
				null,
				"property", null, 0, -1, SubProfile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getSubProfile_Name(),
				ecorePackage.getEString(),
				"name", null, 1, 1, SubProfile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				bundleStartLevelEClass,
				BundleStartLevel.class,
				"BundleStartLevel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getBundleStartLevel_Level(),
				ecorePackage.getEInt(),
				"level", null, 1, 1, BundleStartLevel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getBundleStartLevel_Name(),
				ecorePackage.getEString(),
				"name", null, 1, 1, BundleStartLevel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getProfile_InstallationUnits(), source, new String[] {
				"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "feature" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getProfile_JvmArgument(), source, new String[] {
				"name", "argument", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "element" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getProfile_Setbsl(), source, new String[] {
				"kind", "element" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getProfile_Notes(), source, new String[] {
				"name", "note", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "element" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getProfile_Name(), source, new String[] {
				"kind", "attribute" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(startBundleEClass, source, new String[] {
				"kind", "simple" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getStartBundle_Name(), source, new String[] {
				"name", ":0", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "simple" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(systemPropertyEClass, source, new String[] {
				"kind", "simple" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getSystemProperty_Key(), source, new String[] {
				"kind", "attribute" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getSystemProperty_Value(), source, new String[] {
				"kind", "simple", //$NON-NLS-1$ //$NON-NLS-2$
				"name", ":0" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getSystemProperty_Eval(), source, new String[] {
				"kind", "attribute" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(bundleStartLevelEClass, source, new String[] {
				"name", "BundleStartLevel", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "simple" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getBundleStartLevel_Level(), source, new String[] {
				"kind", "attribute" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getBundleStartLevel_Name(), source, new String[] {
				"name", ":0", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "simple" //$NON-NLS-1$ //$NON-NLS-2$
		});
	}
