...
public class JdbcUserServiceModuleImpl extends MinimalEObjectImpl.Container
	...
	public EList<JdbcUserService> getUserServices() {
		if (userServices == null) {
			userServices = new EObjectContainmentEList.Resolving<JdbcUserService>(
					JdbcUserService.class, this,
					OsgiPackage.JDBC_USER_SERVICE_MODULE__USER_SERVICES);
		}
		return userServices;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case OsgiPackage.JDBC_USER_SERVICE_MODULE__USER_SERVICES:
			return ((InternalEList<?>) getUserServices()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.JDBC_USER_SERVICE_MODULE__USER_SERVICES:
			...
			getUserServices().addAll(
					(Collection<? extends JdbcUserService>) newValue);
			return;
		}
