...
public interface ProfilePackage extends EPackage {
	 ...
	 * @generated
	 */
	ProfilePackage eINSTANCE = org.eclipse.scada.configuration.world.osgi.profile.impl.ProfilePackageImpl
			.init();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute PROFILE__INSTALLATION_UNITS = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute BUNDLE_START_LEVEL__LEVEL = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute BUNDLE_START_LEVEL__NAME = eINSTANCE
