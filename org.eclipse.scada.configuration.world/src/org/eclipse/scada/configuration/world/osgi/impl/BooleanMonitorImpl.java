...
public class BooleanMonitorImpl extends ItemFeatureEntryImpl implements
	...
	public void setReferenceValue(boolean newReferenceValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__REFERENCE_VALUE,
	...
	public void setActive(boolean newActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__ACTIVE, oldActive, active));
	}
	...
	public void setDemotePrefix(String newDemotePrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__DEMOTE_PREFIX,
					oldDemotePrefix, demotePrefix));
	}
	...
	public void setSeverity(Severity newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__SEVERITY, oldSeverity,
					severity));
	}
	...
	public void setMessage(String newMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__MESSAGE, oldMessage, message));
	}
	...
	public void setSuppressEvents(boolean newSuppressEvents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__SUPPRESS_EVENTS,
	...
	public void setRequireAck(boolean newRequireAck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.BOOLEAN_MONITOR__REQUIRE_ACK, oldRequireAck,
					requireAck));
	}
