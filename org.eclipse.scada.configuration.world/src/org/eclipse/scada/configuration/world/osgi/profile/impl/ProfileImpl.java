...
public class ProfileImpl extends MinimalEObjectImpl.Container implements
	...
	public EList<SubProfile> getProfile() {
		if (profile == null) {
			profile = new EObjectContainmentEList.Resolving<SubProfile>(
					SubProfile.class, this, ProfilePackage.PROFILE__PROFILE);
		}
		return profile;
	}
	...
	public EList<Profile> getIncludes() {
		if (includes == null) {
			includes = new EObjectResolvingEList<Profile>(Profile.class, this,
					ProfilePackage.PROFILE__INCLUDES);
		}
		return includes;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProfilePackage.PROFILE__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProfilePackage.PROFILE__DESCRIPTION, oldDescription,
					description));
	}
	...
	public EList<StartBundle> getStart() {
		if (start == null) {
			start = new EObjectContainmentEList.Resolving<StartBundle>(
					StartBundle.class, this, ProfilePackage.PROFILE__START);
		}
		return start;
	}
	...
	public EList<SystemProperty> getProperty() {
		if (property == null) {
			property = new EObjectContainmentEList.Resolving<SystemProperty>(
					...
					ProfilePackage.PROFILE__PROPERTY);
		}
		return property;
	}
	...
	public EList<BundleStartLevel> getSetbsl() {
		if (setbsl == null) {
			setbsl = new EObjectContainmentEList.Resolving<BundleStartLevel>(
					BundleStartLevel.class, this,
					ProfilePackage.PROFILE__SETBSL);
		}
		return setbsl;
	}
	...
	public EList<String> getNotes() {
		if (notes == null) {
			notes = new EDataTypeUniqueEList<String>(String.class, this,
					ProfilePackage.PROFILE__NOTES);
		}
		return notes;
	}
	...
	public EList<String> getInstallationUnits() {
		if (installationUnits == null) {
			installationUnits = new EDataTypeUniqueEList<String>(String.class,
					this, ProfilePackage.PROFILE__INSTALLATION_UNITS);
		}
	...
	public EList<String> getJvmArgument() {
		if (jvmArgument == null) {
			jvmArgument = new EDataTypeUniqueEList<String>(String.class, this,
					ProfilePackage.PROFILE__JVM_ARGUMENT);
		}
		return jvmArgument;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ProfilePackage.PROFILE__PROFILE:
			return ((InternalEList<?>) getProfile())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ProfilePackage.PROFILE__SETBSL:
			getSetbsl().clear();
			getSetbsl().addAll(
					(Collection<? extends BundleStartLevel>) newValue);
			return;
		case ProfilePackage.PROFILE__PROPERTY:
			getProperty().clear();
			getProperty().addAll(
