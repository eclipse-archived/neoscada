...
public class LevelMonitorImpl extends ItemFeatureEntryImpl implements
	...
	public void setPreset(Double newPreset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__PRESET, oldPreset, preset));
	}
	...
	public void setCap(boolean newCap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__CAP, oldCap, cap));
	}
	...
	public void setSeverity(Severity newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__SEVERITY, oldSeverity, severity));
	}
	...
	public void setLowerOk(boolean newLowerOk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__LOWER_OK, oldLowerOk, lowerOk));
	}
	...
	public void setIncludedOk(boolean newIncludedOk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__INCLUDED_OK, oldIncludedOk,
					includedOk));
	}
	...
	public void setPrefix(String newPrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__PREFIX, oldPrefix, prefix));
	}
	...
	public void setDemotePrefix(String newDemotePrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__DEMOTE_PREFIX, oldDemotePrefix,
					demotePrefix));
	}
	...
	public void setSuppressEvents(boolean newSuppressEvents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__SUPPRESS_EVENTS,
					oldSuppressEvents, suppressEvents));
	}
	...
	public void setRequireAck(boolean newRequireAck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__REQUIRE_ACK, oldRequireAck,
					requireAck));
	}
	...
	public void setMonitorType(String newMonitorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.LEVEL_MONITOR__MONITOR_TYPE, oldMonitorType,
					monitorType));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case OsgiPackage.LEVEL_MONITOR__PRESET:
			return PRESET_EDEFAULT == null ? preset != null : !PRESET_EDEFAULT
					.equals(preset);
		case OsgiPackage.LEVEL_MONITOR__CAP:
			return cap != CAP_EDEFAULT;
		case OsgiPackage.LEVEL_MONITOR__SEVERITY:
			return SEVERITY_EDEFAULT == null ? severity != null
					: !SEVERITY_EDEFAULT.equals(severity);
		case OsgiPackage.LEVEL_MONITOR__LOWER_OK:
