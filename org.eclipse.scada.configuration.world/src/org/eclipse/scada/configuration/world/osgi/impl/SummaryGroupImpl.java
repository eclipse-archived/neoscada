...
public class SummaryGroupImpl extends MinimalEObjectImpl.Container implements
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.SUMMARY_GROUP__NAME, oldName, name));
	}
	...
	public EList<SummaryGroup> getSubGroups() {
		if (subGroups == null) {
			subGroups = new EObjectContainmentEList.Resolving<SummaryGroup>(
					SummaryGroup.class, this,
					OsgiPackage.SUMMARY_GROUP__SUB_GROUPS);
		}
		return subGroups;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectResolvingEList<Item>(Item.class, this,
					OsgiPackage.SUMMARY_GROUP__ITEMS);
		}
		return items;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.SUMMARY_GROUP__SUB_GROUPS:
			getSubGroups().clear();
			getSubGroups()
					.addAll((Collection<? extends SummaryGroup>) newValue);
			return;
		case OsgiPackage.SUMMARY_GROUP__ITEMS:
			getItems().clear();
