...
public abstract class MasterServerImpl extends MinimalEObjectImpl.Container implements MasterServer
{
    ...
    public void setShortDescription ( String newShortDescription )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__SHORT_DESCRIPTION, oldShortDescription, shortDescription ) );
    }
    ...
    public void setName ( String newName )
    {
        ...
        name = newName;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__NAME, oldName, name ) );
    }
    ...
    public EList<Connection> getConnections ()
    {
        if ( connections == null )
        {
            connections = new EObjectContainmentEList.Resolving<Connection> ( Connection.class, this, OsgiPackage.MASTER_SERVER__CONNECTIONS );
        }
        return connections;
    }
    ...
    public EList<Exporter> getExporter ()
    {
        if ( exporter == null )
        {
            exporter = new EObjectContainmentEList.Resolving<Exporter> ( Exporter.class, this, OsgiPackage.MASTER_SERVER__EXPORTER );
        }
        return exporter;
    }
    ...
    public NotificationChain basicSetCustomizationProfile ( Profile newCustomizationProfile, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired () )
        {
            ENotificationImpl notification = new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__CUSTOMIZATION_PROFILE, oldCustomizationProfile, newCustomizationProfile );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setCustomizationProfile ( Profile newCustomizationProfile )
    {
        if ( newCustomizationProfile != customizationProfile )
        {
            ...
            if ( customizationProfile != null )
                msgs = ( (InternalEObject)customizationProfile ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.MASTER_SERVER__CUSTOMIZATION_PROFILE, null, msgs );
            if ( newCustomizationProfile != null )
                msgs = ( (InternalEObject)newCustomizationProfile ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.MASTER_SERVER__CUSTOMIZATION_PROFILE, null, msgs );
            msgs = basicSetCustomizationProfile ( newCustomizationProfile, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__CUSTOMIZATION_PROFILE, newCustomizationProfile, newCustomizationProfile ) );
    }
    ...
    public Configuration getSecurityConfiguration ()
    {
        if ( securityConfiguration != null && securityConfiguration.eIsProxy () )
        {
            ...
            {
                if ( eNotificationRequired () )
                    eNotify ( new ENotificationImpl ( this, Notification.RESOLVE, OsgiPackage.MASTER_SERVER__SECURITY_CONFIGURATION, oldSecurityConfiguration, securityConfiguration ) );
            }
        }
    ...
    public void setSecurityConfiguration ( Configuration newSecurityConfiguration )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__SECURITY_CONFIGURATION, oldSecurityConfiguration, securityConfiguration ) );
    }
    ...
    public EList<ApplicationModule> getModules ()
    {
        if ( modules == null )
        {
            modules = new EObjectContainmentEList.Resolving<ApplicationModule> ( ApplicationModule.class, this, OsgiPackage.MASTER_SERVER__MODULES );
        }
        return modules;
    }
    ...
    public EList<SummaryGroup> getSummaryGroups ()
    {
        ...
        {
            summaryGroups = new EObjectContainmentEList.Resolving<SummaryGroup> ( SummaryGroup.class, this, OsgiPackage.MASTER_SERVER__SUMMARY_GROUPS );
        }
    ...
    public EList<Item> getItems ()
    {
        if ( items == null )
        {
            items = new EObjectContainmentEList.Resolving<Item> ( Item.class, this, OsgiPackage.MASTER_SERVER__ITEMS );
        }
        return items;
    }
    ...
    public NotificationChain basicSetMarkers ( Markers newMarkers, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired () )
        {
            ENotificationImpl notification = new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__MARKERS, oldMarkers, newMarkers );
            if ( msgs == null )
                msgs = notification;
            else
                msgs.add ( notification );
    ...
    public void setMarkers ( Markers newMarkers )
    {
        if ( newMarkers != markers )
        {
            NotificationChain msgs = null;
            if ( markers != null )
                msgs = ( (InternalEObject)markers ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.MASTER_SERVER__MARKERS, null, msgs );
            if ( newMarkers != null )
                msgs = ( (InternalEObject)newMarkers ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - OsgiPackage.MASTER_SERVER__MARKERS, null, msgs );
            msgs = basicSetMarkers ( newMarkers, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__MARKERS, newMarkers, newMarkers ) );
    }
    ...
    public void setAeServerInformationPrefix ( String newAeServerInformationPrefix )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.MASTER_SERVER__AE_SERVER_INFORMATION_PREFIX, oldAeServerInformationPrefix, aeServerInformationPrefix ) );
    }
    ...
    public EList<DataMapper> getDataMapper ()
    {
        if ( dataMapper == null )
        {
            dataMapper = new EObjectContainmentEList.Resolving<DataMapper> ( DataMapper.class, this, OsgiPackage.MASTER_SERVER__DATA_MAPPER );
        }
        return dataMapper;
    }
    ...
    public EList<ExternalEventMonitor> getExternalEventMonitors ()
    {
        ...
        {
            externalEventMonitors = new EObjectContainmentEList.Resolving<ExternalEventMonitor> ( ExternalEventMonitor.class, this, OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_MONITORS );
        }
    ...
    public EList<ExternalEventFilter> getExternalEventFilters ()
    {
        ...
        {
            externalEventFilters = new EObjectContainmentEList.Resolving<ExternalEventFilter> ( ExternalEventFilter.class, this, OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_FILTERS );
        }
    ...
    public EList<Average> getAverages ()
    {
        if ( averages == null )
        {
            averages = new EObjectContainmentEList.Resolving<Average> ( Average.class, this, OsgiPackage.MASTER_SERVER__AVERAGES );
        }
        return averages;
    }
    ...
    public EList<MovingAverage> getMovingAverages ()
    {
        ...
        {
            movingAverages = new EObjectContainmentEList.Resolving<MovingAverage> ( MovingAverage.class, this, OsgiPackage.MASTER_SERVER__MOVING_AVERAGES );
        }
    ...
    public NotificationChain eInverseRemove ( InternalEObject otherEnd, int featureID, NotificationChain msgs )
    {
        switch ( featureID )
        {
            ...
            case OsgiPackage.MASTER_SERVER__SUMMARY_GROUPS:
                return ( (InternalEList<?>)getSummaryGroups () ).basicRemove ( otherEnd, msgs );
            ...
            case OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_MONITORS:
                return ( (InternalEList<?>)getExternalEventMonitors () ).basicRemove ( otherEnd, msgs );
            case OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_FILTERS:
                return ( (InternalEList<?>)getExternalEventFilters () ).basicRemove ( otherEnd, msgs );
    ...
    public void eSet ( int featureID, Object newValue )
    {
        switch ( featureID )
        {
            ...
            case OsgiPackage.MASTER_SERVER__SUMMARY_GROUPS:
                ...
                getSummaryGroups ().addAll ( (Collection<? extends SummaryGroup>)newValue );
                return;
            case OsgiPackage.MASTER_SERVER__ITEMS:
                getItems ().clear ();
            ...
            case OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_MONITORS:
                ...
                getExternalEventMonitors ().addAll ( (Collection<? extends ExternalEventMonitor>)newValue );
                return;
            case OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_FILTERS:
                getExternalEventFilters ().clear ();
                getExternalEventFilters ().addAll ( (Collection<? extends ExternalEventFilter>)newValue );
                return;
            case OsgiPackage.MASTER_SERVER__AVERAGES:
                getAverages ().clear ();
    ...
    public boolean eIsSet ( int featureID )
    {
        switch ( featureID )
        {
            ...
            case OsgiPackage.MASTER_SERVER__MARKERS:
                return markers != null;
            case OsgiPackage.MASTER_SERVER__AE_SERVER_INFORMATION_PREFIX:
                return AE_SERVER_INFORMATION_PREFIX_EDEFAULT == null ? aeServerInformationPrefix != null : !AE_SERVER_INFORMATION_PREFIX_EDEFAULT.equals ( aeServerInformationPrefix );
            case OsgiPackage.MASTER_SERVER__MONITOR_POOLS:
            ...
            case OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_MONITORS:
                return externalEventMonitors != null && !externalEventMonitors.isEmpty ();
            case OsgiPackage.MASTER_SERVER__EXTERNAL_EVENT_FILTERS:
                return externalEventFilters != null && !externalEventFilters.isEmpty ();
            case OsgiPackage.MASTER_SERVER__AVERAGES:
