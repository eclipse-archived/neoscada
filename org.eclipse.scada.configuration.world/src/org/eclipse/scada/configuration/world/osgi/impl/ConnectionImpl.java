...
public abstract class ConnectionImpl extends MinimalEObjectImpl.Container
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.CONNECTION__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.CONNECTION__NAME, oldName, name));
	}
			...
			if (endpoint != oldEndpoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.CONNECTION__ENDPOINT, oldEndpoint,
							endpoint));
			}
		}
		return endpoint;
	...
	public void setEndpoint(Endpoint newEndpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.CONNECTION__ENDPOINT, oldEndpoint, endpoint));
	}
	...
	public Credentials getCredentials() {
		if (credentials != null && credentials.eIsProxy()) {
			...
			if (credentials != oldCredentials) {
				...
				NotificationChain msgs = oldCredentials.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- OsgiPackage.CONNECTION__CREDENTIALS, null,
						null);
				if (newCredentials.eInternalContainer() == null) {
					msgs = newCredentials.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE
									- OsgiPackage.CONNECTION__CREDENTIALS,
							null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCredentials(Credentials newCredentials,
			NotificationChain msgs) {
		Credentials oldCredentials = credentials;
		credentials = newCredentials;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, OsgiPackage.CONNECTION__CREDENTIALS,
	...
	public void setCredentials(Credentials newCredentials) {
		if (newCredentials != credentials) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.CONNECTION__CREDENTIALS, newCredentials,
					newCredentials));
	}
	...
	public void setTimeout(Integer newTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.CONNECTION__TIMEOUT, oldTimeout, timeout));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.CONNECTION__ENDPOINT_LABEL:
			return ENDPOINT_LABEL_EDEFAULT == null ? getEndpointLabel() != null
					: !ENDPOINT_LABEL_EDEFAULT.equals(getEndpointLabel());
		case OsgiPackage.CONNECTION__CREDENTIALS:
			return credentials != null;
		case OsgiPackage.CONNECTION__TIMEOUT:
			return TIMEOUT_EDEFAULT == null ? timeout != null
					: !TIMEOUT_EDEFAULT.equals(timeout);
		}
