...
public abstract class ConnectionImpl extends MinimalEObjectImpl.Container implements Connection
{
    ...
    protected ConnectionImpl ()
    {
        ...
        adapter.addNavigatedDependency ( OsgiPackage.Literals.CONNECTION__ENDPOINT, WorldPackage.Literals.ENDPOINT__PORT_NUMBER, WorldPackage.Literals.DOCUMENTABLE__NAME );
    }
