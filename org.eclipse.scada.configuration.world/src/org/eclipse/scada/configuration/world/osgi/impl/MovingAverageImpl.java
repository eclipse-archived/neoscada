...
public class MovingAverageImpl extends MinimalEObjectImpl.Container implements
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE__NAME, oldName, name));
	}
			...
			if (item != oldItem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.MOVING_AVERAGE__ITEM, oldItem, item));
			}
		}
		return item;
	}
	...
	public void setRange(long newRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE__RANGE, oldRange, range));
	}
	...
	public void setNullRange(long newNullRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE__NULL_RANGE, oldNullRange,
					nullRange));
	}
	...
	public void setTrigger(long newTrigger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE__TRIGGER, oldTrigger, trigger));
	}
	...
	public void setTriggerOnly(Boolean newTriggerOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.MOVING_AVERAGE__TRIGGER_ONLY, oldTriggerOnly,
					triggerOnly));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.MOVING_AVERAGE__TRIGGER_ONLY:
			return TRIGGER_ONLY_EDEFAULT == null ? triggerOnly != null
					: !TRIGGER_ONLY_EDEFAULT.equals(triggerOnly);
		}
