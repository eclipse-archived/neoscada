        ...
        EventLogger
{
    ...
    public void setLogAttributesChange ( boolean newLogAttributesChange )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.EVENT_LOGGER__LOG_ATTRIBUTES_CHANGE, oldLogAttributesChange, logAttributesChange ) );
    }
    ...
    public void setLogValueChange ( boolean newLogValueChange )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.EVENT_LOGGER__LOG_VALUE_CHANGE, oldLogValueChange, logValueChange ) );
    }
    ...
    public void setLogSubscriptionChange ( boolean newLogSubscriptionChange )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.EVENT_LOGGER__LOG_SUBSCRIPTION_CHANGE, oldLogSubscriptionChange, logSubscriptionChange ) );
    }
    ...
    public void setLogWrites ( boolean newLogWrites )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, OsgiPackage.EVENT_LOGGER__LOG_WRITES, oldLogWrites, logWrites ) );
    }
