...
public class ExternalEventMonitorImpl extends MinimalEObjectImpl.Container
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EXTERNAL_EVENT_MONITOR__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EXTERNAL_EVENT_MONITOR__NAME, oldName, name));
	}
	...
	public void setFilter(String newFilter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EXTERNAL_EVENT_MONITOR__FILTER, oldFilter,
					filter));
	}
	...
	public EList<PropertyEntry> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList.Resolving<PropertyEntry>(
					...
					OsgiPackage.EXTERNAL_EVENT_MONITOR__PROPERTIES);
		}
		return properties;
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.EXTERNAL_EVENT_MONITOR__NAME:
			return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT
					.equals(name);
		case OsgiPackage.EXTERNAL_EVENT_MONITOR__FILTER:
			return FILTER_EDEFAULT == null ? filter != null : !FILTER_EDEFAULT
					.equals(filter);
		case OsgiPackage.EXTERNAL_EVENT_MONITOR__PROPERTIES:
