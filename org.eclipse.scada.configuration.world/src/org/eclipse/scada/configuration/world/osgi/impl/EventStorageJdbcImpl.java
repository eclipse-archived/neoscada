...
public class EventStorageJdbcImpl extends AbstractEventStorageJdbcImpl
	...
	public void setJdbcDriverName(String newJdbcDriverName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_STORAGE_JDBC__JDBC_DRIVER_NAME,
	...
	public EList<String> getDriverBundles() {
		if (driverBundles == null) {
			driverBundles = new EDataTypeUniqueEList<String>(String.class,
					this, OsgiPackage.EVENT_STORAGE_JDBC__DRIVER_BUNDLES);
		}
	...
	public void setMaxFieldLength(Integer newMaxFieldLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_STORAGE_JDBC__MAX_FIELD_LENGTH,
					oldMaxFieldLength, maxFieldLength));
	}
	...
	public void setQueryFetchSize(Integer newQueryFetchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_STORAGE_JDBC__QUERY_FETCH_SIZE,
					oldQueryFetchSize, queryFetchSize));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case OsgiPackage.EVENT_STORAGE_JDBC__MAX_FIELD_LENGTH:
			return MAX_FIELD_LENGTH_EDEFAULT == null ? maxFieldLength != null
					: !MAX_FIELD_LENGTH_EDEFAULT.equals(maxFieldLength);
		case OsgiPackage.EVENT_STORAGE_JDBC__QUERY_FETCH_SIZE:
			return QUERY_FETCH_SIZE_EDEFAULT == null ? queryFetchSize != null
					: !QUERY_FETCH_SIZE_EDEFAULT.equals(queryFetchSize);
		}
