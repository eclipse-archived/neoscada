...
public class EventStoragePostgresImpl extends AbstractEventStorageJdbcImpl
	...
	public void setBatchSize(Integer newBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.EVENT_STORAGE_POSTGRES__BATCH_SIZE,
	...
	public EList<String> getPostgresDriverBundles() {
		if (postgresDriverBundles == null) {
			postgresDriverBundles = new EDataTypeUniqueEList<String>(
					String.class, this,
					OsgiPackage.EVENT_STORAGE_POSTGRES__POSTGRES_DRIVER_BUNDLES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case OsgiPackage.EVENT_STORAGE_POSTGRES__POSTGRES_DRIVER_BUNDLES:
			...
			getPostgresDriverBundles().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case OsgiPackage.EVENT_STORAGE_POSTGRES__BATCH_SIZE:
			return BATCH_SIZE_EDEFAULT == null ? batchSize != null
					: !BATCH_SIZE_EDEFAULT.equals(batchSize);
		case OsgiPackage.EVENT_STORAGE_POSTGRES__POSTGRES_DRIVER_BUNDLES:
			return postgresDriverBundles != null
					&& !postgresDriverBundles.isEmpty();
		}
