...
public class ScriptTimerImpl extends MinimalEObjectImpl.Container implements
	...
	public CodeFragment getScript() {
		if (script != null && script.eIsProxy()) {
			...
			if (script != oldScript) {
				...
				NotificationChain msgs = oldScript.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- OsgiPackage.SCRIPT_TIMER__SCRIPT, null, null);
				if (newScript.eInternalContainer() == null) {
					msgs = newScript.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- OsgiPackage.SCRIPT_TIMER__SCRIPT, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OsgiPackage.SCRIPT_TIMER__SCRIPT, oldScript, script));
			}
		}
		return script;
	}
	...
	public NotificationChain basicSetScript(CodeFragment newScript,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, OsgiPackage.SCRIPT_TIMER__SCRIPT,
					oldScript, newScript);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setScript(CodeFragment newScript) {
		if (newScript != script) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.SCRIPT_TIMER__SCRIPT, newScript, newScript));
	}
	...
	public void setPeriod(long newPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.SCRIPT_TIMER__PERIOD, oldPeriod, period));
	}
