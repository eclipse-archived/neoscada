...
public abstract class ValueArchiveServerImpl extends
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.VALUE_ARCHIVE_SERVER__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OsgiPackage.VALUE_ARCHIVE_SERVER__NAME, oldName, name));
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList.Resolving<Connection>(
					...
					OsgiPackage.VALUE_ARCHIVE_SERVER__CONNECTIONS);
		}
		return connections;
	}
	...
	public EList<Exporter> getExporter() {
		if (exporter == null) {
			exporter = new EObjectContainmentEList.Resolving<Exporter>(
					Exporter.class, this,
					OsgiPackage.VALUE_ARCHIVE_SERVER__EXPORTER);
		}
		return exporter;
	}
				...
				NotificationChain msgs = oldCustomizationProfile
						.eInverseRemove(
								...
								EOPPOSITE_FEATURE_BASE
										- OsgiPackage.VALUE_ARCHIVE_SERVER__CUSTOMIZATION_PROFILE,
								null, null);
			...
			if (securityConfiguration != oldSecurityConfiguration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							OsgiPackage.VALUE_ARCHIVE_SERVER__SECURITY_CONFIGURATION,
	...
	public EList<ApplicationModule> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList.Resolving<ApplicationModule>(
					...
					OsgiPackage.VALUE_ARCHIVE_SERVER__MODULES);
		}
		return modules;
	}
	...
	public EList<ValueArchive> getArchives() {
		if (archives == null) {
			archives = new EObjectContainmentEList.Resolving<ValueArchive>(
					ValueArchive.class, this,
					OsgiPackage.VALUE_ARCHIVE_SERVER__ARCHIVES);
		}
		return archives;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case OsgiPackage.VALUE_ARCHIVE_SERVER__ARCHIVES:
			return ((InternalEList<?>) getArchives()).basicRemove(otherEnd,
					msgs);
		}
