...
public interface WorldPackage extends EPackage {
	 ...
	 * @generated
	 */
	WorldPackage eINSTANCE = org.eclipse.scada.configuration.world.impl.WorldPackageImpl
			.init();
	 ...
	 * @ordered
	 */
	int DOCUMENTABLE_FEATURE_COUNT = 2;
	 ...
	 * @ordered
	 */
	int NODE__SHORT_DESCRIPTION = DOCUMENTABLE__SHORT_DESCRIPTION;
	 ...
	 * @ordered
	 */
	int NODE__NAME = DOCUMENTABLE__NAME;
	 ...
	 * @ordered
	 */
	int NODE__HOST_NAME = DOCUMENTABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODE__ENDPOINTS = DOCUMENTABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODE__DEPLOYMENTS = DOCUMENTABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NODE_FEATURE_COUNT = DOCUMENTABLE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int NODE_OPERATION_COUNT = DOCUMENTABLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int APPLICATION__SHORT_DESCRIPTION = DOCUMENTABLE__SHORT_DESCRIPTION;
	 ...
	 * @ordered
	 */
	int APPLICATION__NAME = DOCUMENTABLE__NAME;
	 ...
	 * @ordered
	 */
	int APPLICATION_FEATURE_COUNT = DOCUMENTABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int APPLICATION_OPERATION_COUNT = DOCUMENTABLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ENDPOINT__SHORT_DESCRIPTION = DOCUMENTABLE__SHORT_DESCRIPTION;
	 ...
	 * @ordered
	 */
	int ENDPOINT__NAME = DOCUMENTABLE__NAME;
	 ...
	 * @ordered
	 */
	int ENDPOINT__NODE = DOCUMENTABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ENDPOINT__PORT_NUMBER = DOCUMENTABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ENDPOINT_FEATURE_COUNT = DOCUMENTABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ENDPOINT_OPERATION_COUNT = DOCUMENTABLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MASTER_HANDLER_PRIORITIES__SHORT_DESCRIPTION = DOCUMENTABLE__SHORT_DESCRIPTION;
	 ...
	 * @ordered
	 */
	int MASTER_HANDLER_PRIORITIES__NAME = DOCUMENTABLE__NAME;
	 ...
	 * @ordered
	 */
	int MASTER_HANDLER_PRIORITIES__RULES = DOCUMENTABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MASTER_HANDLER_PRIORITIES_FEATURE_COUNT = DOCUMENTABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MASTER_HANDLER_PRIORITIES_OPERATION_COUNT = DOCUMENTABLE_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.scada.configuration.world.Documentable#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see org.eclipse.scada.configuration.world.Documentable#getName()
	 * @see #getDocumentable()
	 * @generated
	 */
	EAttribute getDocumentable_Name();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference APPLICATION_NODE__APPLICATIONS = eINSTANCE
		 ...
		 * @generated
		 */
		EReference APPLICATION_NODE__SERVICES = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute DOCUMENTABLE__SHORT_DESCRIPTION = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute DOCUMENTABLE__NAME = eINSTANCE.getDocumentable_Name();
		 ...
		 * @generated
		 */
		EReference COMMON_DRIVER__PASSWORD = eINSTANCE
		 ...
		 * @generated
		 */
		EReference COMMON_DRIVER__ENDPOINTS = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute HANDLER_PRIORITY_RULE__ORDER = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute HANDLER_PRIORITY_RULE__FACTORY_ID = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute HANDLER_PRIORITY_RULE__CONFIGURATION_FILTER = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute HANDLER_PRIORITY_RULE__PRIORITY = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute HANDLER_PRIORITY_RULE__DESCRIPTION = eINSTANCE
		 ...
		 * @generated
		 */
		EClass MASTER_HANDLER_PRIORITIES = eINSTANCE
		 ...
		 * @generated
		 */
		EReference MASTER_HANDLER_PRIORITIES__RULES = eINSTANCE
		 ...
		 * @generated
		 */
		EReference OPTIONS__MASTER_HANDLER_PRIORITIES = eINSTANCE
		 ...
		 * @generated
		 */
		EClass USERNAME_PASSWORD_CREDENTIALS = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute USERNAME_PASSWORD_CREDENTIALS__USERNAME = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute USERNAME_PASSWORD_CREDENTIALS__PASSWORD = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute PASSWORD_CREDENTIALS__PASSWORD = eINSTANCE
