...
public class DeploymentFactoryImpl extends EFactoryImpl implements
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case DeploymentPackage.FALLBACK_NODE_MAPPING_MODE:
			return createFallbackNodeMappingModeFromString(eDataType,
					initialValue);
		default:
			throw new IllegalArgumentException(
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case DeploymentPackage.FALLBACK_NODE_MAPPING_MODE:
			return convertFallbackNodeMappingModeToString(eDataType,
					instanceValue);
		default:
			throw new IllegalArgumentException(
					"The datatype '" + eDataType.getName() + "' is not a valid classifier"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public FallbackNodeMappingMode createFallbackNodeMappingModeFromString(
		...
		FallbackNodeMappingMode result = FallbackNodeMappingMode
				.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
