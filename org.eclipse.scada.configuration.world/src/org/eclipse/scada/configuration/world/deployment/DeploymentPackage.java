...
public interface DeploymentPackage extends EPackage
{
     ...
     * @ordered
     */
    int NODE_MAPPINGS__FALLBACK_MODE = 0;
     ...
     * @ordered
     */
    int SIMPLE_NODE_MAPPING_ENTRY_FEATURE_COUNT = MAPPING_ENTRY_FEATURE_COUNT + 2;
