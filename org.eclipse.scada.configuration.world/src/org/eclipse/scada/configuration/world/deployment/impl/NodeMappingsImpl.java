...
public class NodeMappingsImpl extends MinimalEObjectImpl.Container implements
	...
	public EList<NodeMappingEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList.Resolving<NodeMappingEntry>(
					NodeMappingEntry.class, this,
					DeploymentPackage.NODE_MAPPINGS__ENTRIES);
		}
		return entries;
	}
	...
	public void setFallbackMode(FallbackNodeMappingMode newFallbackMode) {
		...
		fallbackMode = newFallbackMode == null ? FALLBACK_MODE_EDEFAULT
				: newFallbackMode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DeploymentPackage.NODE_MAPPINGS__FALLBACK_MODE,
					oldFallbackMode, fallbackMode));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DeploymentPackage.NODE_MAPPINGS__ENTRIES:
			getEntries().clear();
			getEntries().addAll(
					(Collection<? extends NodeMappingEntry>) newValue);
			return;
		case DeploymentPackage.NODE_MAPPINGS__FALLBACK_MODE:
