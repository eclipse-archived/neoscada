...
public abstract class CommonDeploymentMechanismImpl extends
	...
	public EList<ChangeEntry> getChanges() {
		if (changes == null) {
			changes = new EObjectContainmentEList.Resolving<ChangeEntry>(
					ChangeEntry.class, this,
					DeploymentPackage.COMMON_DEPLOYMENT_MECHANISM__CHANGES);
		}
		return changes;
	}
			...
			if (maintainer != oldMaintainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							DeploymentPackage.COMMON_DEPLOYMENT_MECHANISM__MAINTAINER,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case DeploymentPackage.COMMON_DEPLOYMENT_MECHANISM__CHANGES:
			return ((InternalEList<?>) getChanges())
