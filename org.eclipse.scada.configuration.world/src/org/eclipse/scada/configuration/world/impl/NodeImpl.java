...
public abstract class NodeImpl extends MinimalEObjectImpl.Container implements
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.NODE__SHORT_DESCRIPTION, oldShortDescription,
					shortDescription));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.NODE__NAME, oldName, name));
	}
	...
	public void setHostName(String newHostName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.NODE__HOST_NAME, oldHostName, hostName));
	}
	...
	public EList<Endpoint> getEndpoints() {
		if (endpoints == null) {
			endpoints = new EObjectContainmentWithInverseEList.Resolving<Endpoint>(
					Endpoint.class, this, WorldPackage.NODE__ENDPOINTS,
					WorldPackage.ENDPOINT__NODE);
		}
		return endpoints;
	}
	...
	public EList<DeploymentMechanism> getDeployments() {
		if (deployments == null) {
			deployments = new EObjectContainmentEList.Resolving<DeploymentMechanism>(
					DeploymentMechanism.class, this,
					WorldPackage.NODE__DEPLOYMENTS);
		}
		return deployments;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case WorldPackage.NODE__ENDPOINTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getEndpoints())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case WorldPackage.NODE__ENDPOINTS:
			return ((InternalEList<?>) getEndpoints()).basicRemove(otherEnd,
					msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case WorldPackage.NODE__DEPLOYMENTS:
			...
			getDeployments().addAll(
					(Collection<? extends DeploymentMechanism>) newValue);
			return;
		}
