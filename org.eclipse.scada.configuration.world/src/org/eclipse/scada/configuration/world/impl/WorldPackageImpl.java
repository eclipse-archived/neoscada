...
public class WorldPackageImpl extends EPackageImpl implements WorldPackage {
	...
	public static WorldPackage init() {
		if (isInited)
			return (WorldPackage) EPackage.Registry.INSTANCE
					.getEPackage(WorldPackage.eNS_URI);

		// Obtain or create and register package
		WorldPackageImpl theWorldPackage = (WorldPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof WorldPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new WorldPackageImpl());
		...
		OsgiPackageImpl theOsgiPackage = (OsgiPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(OsgiPackage.eNS_URI) instanceof OsgiPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(OsgiPackage.eNS_URI) : OsgiPackage.eINSTANCE);
	...
	public EReference getApplicationNode_Applications() {
		return (EReference) applicationNodeEClass.getEStructuralFeatures().get(
				0);
	}
	 ...
	 */
	@Override
	public EAttribute getDocumentable_Name() {
		return (EAttribute) documentableEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getHandlerPriorityRule_Order() {
		return (EAttribute) handlerPriorityRuleEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getMasterHandlerPriorities_Rules() {
		return (EReference) masterHandlerPrioritiesEClass
	...
	public EAttribute getUsernamePasswordCredentials_Username() {
		return (EAttribute) usernamePasswordCredentialsEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getPasswordCredentials_Password() {
		return (EAttribute) passwordCredentialsEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentableEClass, DOCUMENTABLE__NAME);
		...
		createEAttribute(handlerPriorityRuleEClass,
		...
		createEReference(masterHandlerPrioritiesEClass,
		...
		createEAttribute(usernamePasswordCredentialsEClass,
		...
		createEAttribute(passwordCredentialsEClass,
	...
	public void initializePackageContents() {
		...
		OsgiPackage theOsgiPackage = (OsgiPackage) EPackage.Registry.INSTANCE
				.getEPackage(OsgiPackage.eNS_URI);
		DeploymentPackage theDeploymentPackage = (DeploymentPackage) EPackage.Registry.INSTANCE
				.getEPackage(DeploymentPackage.eNS_URI);
		...
		nodeEClass.getESuperTypes().add(this.getDocumentable());
		applicationNodeEClass.getESuperTypes().add(this.getNode());
		applicationEClass.getESuperTypes().add(this.getDocumentable());
		driverEClass.getESuperTypes().add(this.getApplication());
		endpointEClass.getESuperTypes().add(this.getDocumentable());
		execDriverEClass.getESuperTypes().add(this.getCommonDriver());
		commonDriverEClass.getESuperTypes().add(this.getDriver());
		masterHandlerPrioritiesEClass.getESuperTypes().add(
				this.getDocumentable());
		usernamePasswordCredentialsEClass.getESuperTypes().add(
				this.getCredentials());
		...
		initEClass(
				worldEClass,
				World.class,
				"World", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getWorld_Nodes(),
				this.getNode(),
				null,
				"nodes", null, 0, -1, World.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getWorld_Options(),
				this.getOptions(),
				null,
				"options", null, 0, 1, World.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(
				...
				"hostName", null, 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getNode_Endpoints(),
				this.getEndpoint(),
				this.getEndpoint_Node(),
				"endpoints", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getNode_Deployments(),
				theDeploymentPackage.getDeploymentMechanism(),
				null,
				"deployments", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				applicationNodeEClass,
				ApplicationNode.class,
				"ApplicationNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getApplicationNode_Applications(),
				this.getApplication(),
				null,
				"applications", null, 0, -1, ApplicationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getApplicationNode_Services(),
				this.getService(),
				null,
				"services", null, 0, -1, ApplicationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				documentableEClass,
				Documentable.class,
				"Documentable", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getDocumentable_ShortDescription(),
				ecorePackage.getEString(),
				"shortDescription", null, 0, 1, Documentable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getDocumentable_Name(),
				ecorePackage.getEString(),
				"name", null, 0, 1, Documentable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				applicationEClass,
				Application.class,
				"Application", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(
				driverEClass,
				Driver.class,
				"Driver", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEOperation(getDriver__GetEndpoints(), this.getEndpoint(),
				"getEndpoints", 0, -1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				endpointEClass,
				Endpoint.class,
				"Endpoint", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getEndpoint_Node(),
				this.getNode(),
				this.getNode_Endpoints(),
				"node", null, 1, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		getEndpoint_Node().getEKeys().add(this.getNode_HostName());
		initEAttribute(
				getEndpoint_PortNumber(),
				ecorePackage.getEShort(),
				"portNumber", null, 1, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				execDriverEClass,
				ExecDriver.class,
				"ExecDriver", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getExecDriver_Root(),
				theConfigurationPackage.getRootType(),
				null,
				"root", null, 0, 1, ExecDriver.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				commonDriverEClass,
				CommonDriver.class,
				"CommonDriver", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getCommonDriver_Password(),
				this.getPasswordCredentials(),
				null,
				"password", null, 0, 1, CommonDriver.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getCommonDriver_Endpoints(),
				this.getEndpoint(),
				null,
				"endpoints", null, 0, -1, CommonDriver.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		getCommonDriver_Endpoints().getEKeys().add(
				this.getEndpoint_PortNumber());

		initEClass(
				handlerPriorityRuleEClass,
				HandlerPriorityRule.class,
				"HandlerPriorityRule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getHandlerPriorityRule_Order(),
				ecorePackage.getEInt(),
				"order", null, 1, 1, HandlerPriorityRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getHandlerPriorityRule_FactoryId(),
				ecorePackage.getEString(),
				"factoryId", null, 0, 1, HandlerPriorityRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getHandlerPriorityRule_ConfigurationFilter(),
				this.getPattern(),
				"configurationFilter", null, 0, 1, HandlerPriorityRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getHandlerPriorityRule_Priority(),
				ecorePackage.getEInt(),
				"priority", null, 1, 1, HandlerPriorityRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getHandlerPriorityRule_Description(),
				ecorePackage.getEString(),
				"description", null, 0, 1, HandlerPriorityRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				masterHandlerPrioritiesEClass,
				MasterHandlerPriorities.class,
				"MasterHandlerPriorities", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getMasterHandlerPriorities_Rules(),
				this.getHandlerPriorityRule(),
				null,
				"rules", null, 0, -1, MasterHandlerPriorities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				optionsEClass,
				Options.class,
				"Options", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getOptions_MasterHandlerPriorities(),
				this.getMasterHandlerPriorities(),
				null,
				"masterHandlerPriorities", null, 0, 1, Options.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				usernamePasswordCredentialsEClass,
				UsernamePasswordCredentials.class,
				"UsernamePasswordCredentials", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getUsernamePasswordCredentials_Username(),
				ecorePackage.getEString(),
				"username", null, 1, 1, UsernamePasswordCredentials.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getUsernamePasswordCredentials_Password(),
				ecorePackage.getEString(),
				"password", null, 1, 1, UsernamePasswordCredentials.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				passwordCredentialsEClass,
				PasswordCredentials.class,
				"PasswordCredentials", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getPasswordCredentials_Password(),
				ecorePackage.getEString(),
				"password", null, 1, 1, PasswordCredentials.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				credentialsEClass,
				Credentials.class,
				"Credentials", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(
				externalNodeEClass,
				ExternalNode.class,
				"ExternalNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		...
		initEDataType(patternEDataType, Pattern.class,
				"Pattern", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
