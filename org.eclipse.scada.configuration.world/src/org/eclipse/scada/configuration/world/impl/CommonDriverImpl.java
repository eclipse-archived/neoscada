...
public abstract class CommonDriverImpl extends MinimalEObjectImpl.Container
	...
	public void setShortDescription(String newShortDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.COMMON_DRIVER__SHORT_DESCRIPTION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.COMMON_DRIVER__NAME, oldName, name));
	}
	...
	public EList<Endpoint> getEndpoints() {
		if (endpoints == null) {
			endpoints = new EObjectResolvingEList<Endpoint>(Endpoint.class,
					this, WorldPackage.COMMON_DRIVER__ENDPOINTS);
		}
		return endpoints;
	}
	...
	public PasswordCredentials getPassword() {
		if (password != null && password.eIsProxy()) {
			...
			if (password != oldPassword) {
				...
				NotificationChain msgs = oldPassword.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- WorldPackage.COMMON_DRIVER__PASSWORD, null,
						null);
				if (newPassword.eInternalContainer() == null) {
					msgs = newPassword.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- WorldPackage.COMMON_DRIVER__PASSWORD, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							WorldPackage.COMMON_DRIVER__PASSWORD, oldPassword,
							password));
			}
		}
		return password;
	...
	public NotificationChain basicSetPassword(PasswordCredentials newPassword,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, WorldPackage.COMMON_DRIVER__PASSWORD,
	...
	public void setPassword(PasswordCredentials newPassword) {
		if (newPassword != password) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.COMMON_DRIVER__PASSWORD, newPassword,
					newPassword));
	}
