...
public class HandlerPriorityRuleImpl extends MinimalEObjectImpl.Container
	...
	public void setOrder(int newOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.HANDLER_PRIORITY_RULE__ORDER, oldOrder, order));
	}
	...
	public void setFactoryId(String newFactoryId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.HANDLER_PRIORITY_RULE__FACTORY_ID,
					oldFactoryId, factoryId));
	}
	...
	public void setConfigurationFilter(Pattern newConfigurationFilter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.HANDLER_PRIORITY_RULE__CONFIGURATION_FILTER,
					oldConfigurationFilter, configurationFilter));
	}
	...
	public void setPriority(int newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.HANDLER_PRIORITY_RULE__PRIORITY, oldPriority,
					priority));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.HANDLER_PRIORITY_RULE__DESCRIPTION,
	...
	public boolean eIsSet(int featureID) {
		...
		case WorldPackage.HANDLER_PRIORITY_RULE__FACTORY_ID:
			return FACTORY_ID_EDEFAULT == null ? factoryId != null
					: !FACTORY_ID_EDEFAULT.equals(factoryId);
		case WorldPackage.HANDLER_PRIORITY_RULE__CONFIGURATION_FILTER:
			return CONFIGURATION_FILTER_EDEFAULT == null ? configurationFilter != null
					: !CONFIGURATION_FILTER_EDEFAULT
							.equals(configurationFilter);
		case WorldPackage.HANDLER_PRIORITY_RULE__PRIORITY:
