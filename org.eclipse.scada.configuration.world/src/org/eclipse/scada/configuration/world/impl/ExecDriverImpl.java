	...
	public RootType getRoot() {
		if (root != null && root.eIsProxy()) {
			...
			if (root != oldRoot) {
				...
				NotificationChain msgs = oldRoot
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- WorldPackage.EXEC_DRIVER__ROOT, null, null);
				if (newRoot.eInternalContainer() == null) {
					msgs = newRoot.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- WorldPackage.EXEC_DRIVER__ROOT, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							WorldPackage.EXEC_DRIVER__ROOT, oldRoot, root));
			}
		}
		return root;
	}
	...
	public NotificationChain basicSetRoot(RootType newRoot,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, WorldPackage.EXEC_DRIVER__ROOT, oldRoot,
					newRoot);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRoot(RootType newRoot) {
		if (newRoot != root) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					WorldPackage.EXEC_DRIVER__ROOT, newRoot, newRoot));
	}
