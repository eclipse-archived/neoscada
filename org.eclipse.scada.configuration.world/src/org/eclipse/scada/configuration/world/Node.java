 ...
 * <ul>
 * <li>{@link org.eclipse.scada.configuration.world.Node#getHostName <em>Host
 * Name</em>}</li>
 * <li>{@link org.eclipse.scada.configuration.world.Node#getEndpoints <em>
 * Endpoints</em>}</li>
 * <li>{@link org.eclipse.scada.configuration.world.Node#getDeployments <em>
 * Deployments</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface Node extends NamedDocumentable
{
    ...
    /**
     * Returns the value of the '<em><b>Endpoints</b></em>' containment
     * reference list.
    ...
    /**
     * Returns the value of the '<em><b>Deployments</b></em>' containment
     * reference list.
     * The list contents are of type
