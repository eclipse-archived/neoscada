...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Driver Instance</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.scada.configuration.driver.jdbc.impl.JdbcDriverInstanceImpl#getRoot <em>Root</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class JdbcDriverInstanceImpl extends CommonDriverImpl implements JdbcDriverInstance
{
    /**
     ...
     * @generated
     */
    protected JdbcDriverInstanceImpl ()
    {
        super ();
    }
    ...
    {
        return JdbcPackage.Literals.JDBC_DRIVER_INSTANCE;
    }
    ...
    public NotificationChain basicSetRoot ( RootType newRoot, NotificationChain msgs )
    {
        ...
        if ( eNotificationRequired () )
        {
            ENotificationImpl notification = new ENotificationImpl ( this, Notification.SET, JdbcPackage.JDBC_DRIVER_INSTANCE__ROOT, oldRoot, newRoot );
            if ( msgs == null )
                msgs = notification;
            else
    ...
    public void setRoot ( RootType newRoot )
    {
        if ( newRoot != root )
        {
            ...
            if ( root != null )
                msgs = ( (InternalEObject)root ).eInverseRemove ( this, EOPPOSITE_FEATURE_BASE - JdbcPackage.JDBC_DRIVER_INSTANCE__ROOT, null, msgs );
            if ( newRoot != null )
                msgs = ( (InternalEObject)newRoot ).eInverseAdd ( this, EOPPOSITE_FEATURE_BASE - JdbcPackage.JDBC_DRIVER_INSTANCE__ROOT, null, msgs );
            msgs = basicSetRoot ( newRoot, msgs );
            if ( msgs != null )
                msgs.dispatch ();
        }
        else if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, JdbcPackage.JDBC_DRIVER_INSTANCE__ROOT, newRoot, newRoot ) );
    }
    ...
    public NotificationChain eInverseRemove ( InternalEObject otherEnd, int featureID, NotificationChain msgs )
    {
        switch ( featureID )
        {
            case JdbcPackage.JDBC_DRIVER_INSTANCE__ROOT:
