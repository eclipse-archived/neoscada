...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.da.server.component.parser.factory.configuration.SinglePattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SinglePatternItemProvider
        ...
        IItemPropertySource
{
     ...
     * @generated
     */
    public SinglePatternItemProvider ( AdapterFactory adapterFactory )
    {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors ( Object object )
    {
        if ( itemPropertyDescriptors == null )
        {
            ...
            addFullMatchPropertyDescriptor ( object );
        }
    ...
    protected void addPatternPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_SinglePattern_pattern_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_SinglePattern_pattern_feature", "_UI_SinglePattern_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ParserPackage.Literals.SINGLE_PATTERN__PATTERN,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/SinglePattern" ) ); //$NON-NLS-1$
    }
    ...
    {
        String label = ( (SinglePattern)object ).getPrefix ();
        return label == null || label.length () == 0 ?
                getString ( "_UI_SinglePattern_type" ) : //$NON-NLS-1$
                getString ( "_UI_SinglePattern_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
