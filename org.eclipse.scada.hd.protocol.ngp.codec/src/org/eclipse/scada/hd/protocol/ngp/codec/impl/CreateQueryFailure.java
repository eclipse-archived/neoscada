...
public class CreateQueryFailure implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( CreateQueryFailure.class );

    public static final int MESSAGE_CODE = 12290;
    ...
    {
        return org.eclipse.scada.hd.data.message.CreateQueryFailure.class;
    }
    ...
    {
        final org.eclipse.scada.hd.data.message.CreateQueryFailure value = (org.eclipse.scada.hd.data.message.CreateQueryFailure)objectMessage;
