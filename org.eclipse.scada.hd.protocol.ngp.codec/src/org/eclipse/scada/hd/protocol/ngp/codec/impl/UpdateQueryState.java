...
public class UpdateQueryState implements BinaryMessageCodec
{
    ...
    public static final int MESSAGE_CODE = 12293;
    ...
    {
        return org.eclipse.scada.hd.data.message.UpdateQueryState.class;
    }

    @Override
    public org.eclipse.scada.hd.data.message.UpdateQueryState decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        for ( int i = 0; i < numberOfFields; i++ )
        {
            ...
            switch ( fieldNumber )
            {
                ...
                case 2:
                {
                    state = _context.decodeString ( _data );
                }
                    break;
                default:
        ...
        // create object
        return new org.eclipse.scada.hd.data.message.UpdateQueryState ( queryId, state );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.hd.data.message.UpdateQueryState value = (org.eclipse.scada.hd.data.message.UpdateQueryState)objectMessage;
        ...
        context.encodeString ( data, (byte)2, value.getState () );
