...
public class CloseQuery implements BinaryMessageCodec
{
    ...
    public static final int MESSAGE_CODE = 12291;
    ...
    {
        return org.eclipse.scada.hd.data.message.CloseQuery.class;
    }

    @Override
    public org.eclipse.scada.hd.data.message.CloseQuery decodeMessage ( final BinaryContext _context, final IoBuffer _data ) throws Exception
    {
        // message code
        {
        ...
        // create object
        return new org.eclipse.scada.hd.data.message.CloseQuery ( queryId );
    }

    @Override
    public IoBuffer encodeMessage ( final BinaryContext context, final Object objectMessage ) throws Exception
    {
        final org.eclipse.scada.hd.data.message.CloseQuery value = (org.eclipse.scada.hd.data.message.CloseQuery)objectMessage;
