...
public class StartBrowse implements BinaryMessageCodec
{
    private final static Logger logger = LoggerFactory.getLogger ( StartBrowse.class );

    public static final int MESSAGE_CODE = 12545;
    ...
    {
        return org.eclipse.scada.hd.data.message.StartBrowse.class;
    }
