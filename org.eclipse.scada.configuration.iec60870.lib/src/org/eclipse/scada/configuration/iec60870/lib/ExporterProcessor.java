...
{
    private static final String BUNDLE_IEC60870_EXPORTER = "org.eclipse.scada.da.server.exporter.iec60870"; //$NON-NLS-1$

    private static final String DEVICE_FACTORY_ID = "org.eclipse.scada.da.server.exporter.iec60870.device"; //$NON-NLS-1$
