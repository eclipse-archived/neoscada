 ...
 * {@link org.eclipse.scada.configuration.iec60870.IEC60870Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class IEC60870DeviceItemProvider extends DeviceItemProvider
{
    /**
     ...
     * @generated
     */
    public IEC60870DeviceItemProvider ( final AdapterFactory adapterFactory )
    {
    ...
    {
        this.itemPropertyDescriptors.add ( createItemPropertyDescriptor ( ( (ComposeableAdapterFactory)this.adapterFactory ).getRootAdapterFactory (), getResourceLocator (), getString ( "_UI_IEC60870Device_port_feature" ), //$NON-NLS-1$
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( final Object object )
    {
        if ( this.childrenFeatures == null )
        {
            ...
            this.childrenFeatures.add ( IEC60870Package.Literals.IEC60870_DEVICE__DATA_MODULE_OPTIONS );
            this.childrenFeatures.add ( IEC60870Package.Literals.IEC60870_DEVICE__PROTOCOL_OPTIONS );
        }
    ...
    /**
     * This returns IEC60870Device.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/IEC60870Device" ) ); //$NON-NLS-1$
    }

    @Override
    protected String getDeviceType ()
    {
        return getString ( "_UI_IEC60870Device_type" );
    }
    ...
    public void notifyChanged ( final Notification notification )
    {
        ...
        switch ( notification.getFeatureID ( IEC60870Device.class ) )
        {
