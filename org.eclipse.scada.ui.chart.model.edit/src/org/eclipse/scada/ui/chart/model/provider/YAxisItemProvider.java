        ...
        ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addMinimumPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_YAxis_minimum_feature", "_UI_YAxis_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ChartPackage.Literals.YAXIS__MINIMUM,
                        true,
                        false,
                        false,
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/YAxis" ) ); //$NON-NLS-1$
    }
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_YAxis_type" ) : //$NON-NLS-1$
