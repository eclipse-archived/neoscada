	...
	protected void addDiffPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CurrentTimeController_diff_feature", "_UI_CurrentTimeController_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addAlignDateFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CurrentTimeController_alignDateFormat_feature", "_UI_CurrentTimeController_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addTimespanPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CurrentTimeController_timespan_feature", "_UI_CurrentTimeController_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/CurrentTimeController")); //$NON-NLS-1$
	}
