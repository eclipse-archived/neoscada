...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.ui.chart.model.ArchiveChannel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchiveChannelItemProvider extends ItemProviderAdapter implements
        ...
        ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addNamePropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        getResourceLocator (),
                        getString ( "_UI_ArchiveChannel_name_feature" ), //$NON-NLS-1$
                        getString ( "_UI_PropertyDescriptor_description", "_UI_ArchiveChannel_name_feature", "_UI_ArchiveChannel_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ChartPackage.Literals.ARCHIVE_CHANNEL__NAME,
                        true,
                        false,
                        false,
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/ArchiveChannel" ) ); //$NON-NLS-1$
    }
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_ArchiveChannel_type" ) : //$NON-NLS-1$
                getString ( "_UI_ArchiveChannel_type" ) + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
            ...
            Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add
                ...
                ( ChartPackage.Literals.ARCHIVE_CHANNEL__LINE_PROPERTIES,
                        ChartFactory.eINSTANCE.createLineProperties () ) );
    }
