        ...
        ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    protected void addLabelPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_Axis_label_feature", "_UI_Axis_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ChartPackage.Literals.AXIS__LABEL,
                        true,
                        false,
                        false,
    ...
    protected void addColorPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_Axis_color_feature", "_UI_Axis_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ChartPackage.Literals.AXIS__COLOR,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addLabelVisiblePropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_Axis_labelVisible_feature", "_UI_Axis_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ChartPackage.Literals.AXIS__LABEL_VISIBLE,
                        true,
                        false,
                        false,
    ...
    public String getText ( Object object )
    {
        ...
        return label == null || label.length () == 0 ?
                getString ( "_UI_Axis_type" ) : //$NON-NLS-1$
