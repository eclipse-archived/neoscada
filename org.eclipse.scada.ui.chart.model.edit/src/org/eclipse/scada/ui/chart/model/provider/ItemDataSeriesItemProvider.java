...
/**
 * This is the item provider adapter for a {@link org.eclipse.scada.ui.chart.model.ItemDataSeries} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemDataSeriesItemProvider extends DataSeriesItemProvider
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ItemDataSeries_type") : //$NON-NLS-1$
				getString("_UI_ItemDataSeries_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ChartPackage.Literals.ITEM_DATA_SERIES__ITEM,
				ChartFactory.eINSTANCE.createUriItem()));

		newChildDescriptors.add(createChildParameter(
				ChartPackage.Literals.ITEM_DATA_SERIES__ITEM,
				ChartFactory.eINSTANCE.createIdItem()));
	}
