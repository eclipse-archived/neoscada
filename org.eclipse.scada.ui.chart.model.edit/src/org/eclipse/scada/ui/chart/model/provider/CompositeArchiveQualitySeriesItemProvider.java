...
public class CompositeArchiveQualitySeriesItemProvider extends
	...
	protected void addThresholdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CompositeArchiveQualitySeries_threshold_feature", "_UI_CompositeArchiveQualitySeries_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/CompositeArchiveQualitySeries")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_CompositeArchiveQualitySeries_type") : //$NON-NLS-1$
