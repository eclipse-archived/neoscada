...
public class HiveCreatorImpl implements HiveCreator
{
    ...
    {
        if ( !reference.equals ( org.eclipse.scada.da.server.exec.Hive.class.getName () ) )
        {
            return null;
        }
        ...
        {
            return new org.eclipse.scada.da.server.exec.Hive ( (RootType)configuration );
        }
        else if ( configuration instanceof String )
        {
            return new org.eclipse.scada.da.server.exec.Hive ( (String)configuration );
        }
        else
        {
            return null;
