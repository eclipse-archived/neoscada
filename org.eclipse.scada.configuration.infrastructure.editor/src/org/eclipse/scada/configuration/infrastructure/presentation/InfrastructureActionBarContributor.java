...
public class InfrastructureActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    ...
    protected IAction refreshViewerAction = new Action ( InfrastructureEditorPlugin.INSTANCE.getString ( "_UI_RefreshViewer_menu_item" )) {
        ...
        {
            return InfrastructureActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run ()
        {
            if ( InfrastructureActionBarContributor.this.activeEditorPart instanceof IViewerProvider )
            {
                final Viewer viewer = ( (IViewerProvider)InfrastructureActionBarContributor.this.activeEditorPart ).getViewer ();
                if ( viewer != null )
                {
                    viewer.refresh ( );
                }
    ...
    public void contributeToMenu ( final IMenuManager menuManager )
    {
        ...
        final IMenuManager submenuManager = new MenuManager ( InfrastructureEditorPlugin.INSTANCE.getString ( "_UI_InfrastructureEditor_menu" ), "org.eclipse.scada.configuration.infrastructureMenuID" ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //
        this.createChildMenuManager = new MenuManager ( InfrastructureEditorPlugin.INSTANCE.getString ( "_UI_CreateChild_menu_item" ) ); //$NON-NLS-1$
        submenuManager.insertBefore ( "additions", this.createChildMenuManager ); //$NON-NLS-1$

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager ( InfrastructureEditorPlugin.INSTANCE.getString ( "_UI_CreateSibling_menu_item" ) ); //$NON-NLS-1$
    ...
    public void menuAboutToShow ( final IMenuManager menuManager )
    {
        ...
        submenuManager = new MenuManager ( InfrastructureEditorPlugin.INSTANCE.getString ( "_UI_CreateChild_menu_item" ) ); //$NON-NLS-1$
        ...
        submenuManager = new MenuManager ( InfrastructureEditorPlugin.INSTANCE.getString ( "_UI_CreateSibling_menu_item" ) ); //$NON-NLS-1$
