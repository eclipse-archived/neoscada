...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>exec</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecComponentsExample
{
    /**
     * <!-- begin-user-doc -->
    ...
    public static void main ( String[] args )
    {
        ...
        resourceSet.getPackageRegistry ().put
                ( ExecComponentsPackage.eNS_URI,
                        ExecComponentsPackage.eINSTANCE );
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.execcomponents" ) ); //$NON-NLS-1$
                ExecJob root = ExecComponentsFactory.eINSTANCE.createExecJob ();
