...
/**
 * This is the action bar contributor for the Globalize model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GlobalizeActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_ShowPropertiesView_menu_item" ) ) //$NON-NLS-1$
    {
        @Override
        public void run ()
        {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_RefreshViewer_menu_item" ) ) //$NON-NLS-1$
    {
        @Override
     ...
     * @generated
     */
    public GlobalizeActionBarContributor ()
    {
    ...
    public void contributeToMenu ( IMenuManager menuManager )
    {
        ...
        IMenuManager submenuManager = new MenuManager ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_GlobalizeEditor_menu" ), "org.eclipse.scada.configuration.globalizationMenuID" ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //
        createChildMenuManager = new MenuManager ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_CreateChild_menu_item" ) ); //$NON-NLS-1$
        submenuManager.insertBefore ( "additions", createChildMenuManager ); //$NON-NLS-1$

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_CreateSibling_menu_item" ) ); //$NON-NLS-1$
    ...
    public void menuAboutToShow ( IMenuManager menuManager )
    {
        ...
        submenuManager = new MenuManager ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_CreateChild_menu_item" ) ); //$NON-NLS-1$
        populateManager ( submenuManager, createChildSubmenuActions, null );
        populateManager ( submenuManager, createChildActions, null );
        menuManager.insertBefore ( "edit", submenuManager ); //$NON-NLS-1$

        submenuManager = new MenuManager ( GlobalizeEditorPlugin.INSTANCE.getString ( "_UI_CreateSibling_menu_item" ) ); //$NON-NLS-1$
