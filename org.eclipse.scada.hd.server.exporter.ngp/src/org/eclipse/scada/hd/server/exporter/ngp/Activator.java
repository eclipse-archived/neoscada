 ...
 *******************************************************************************/
package org.eclipse.scada.hd.server.exporter.ngp;

import org.eclipse.scada.core.ConnectionInformation;
import org.eclipse.scada.hd.server.Service;
import org.eclipse.scada.hd.server.ngp.Exporter;
...
public class Activator implements BundleActivator
{
    ...
    protected void handleServiceChange ( final Service service )
    {
        ...
        try
        {
            ...
            if ( service != null )
            {
                this.exporter = new Exporter ( service, ConnectionInformation.fromURI ( System.getProperty ( "org.eclipse.scada.hd.server.exporter.ngp.exportUri", "hd:ngp://0.0.0.0:2301" ) ) );
                this.exporter.start ();
            }
        }
