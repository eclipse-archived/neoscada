...
import org.eclipse.scada.configuration.component.common.util.CommonResourceFactoryImpl;
...
public class CommonExample
{
    ...
    public static void main ( String[] args )
    {
        ...
        if ( args.length == 0 )
        {
            ...
            try
            {
                Resource resource = resourceSet.createResource ( URI.createURI ( "http:///My.common" ) ); //$NON-NLS-1$
                ToggleHeartbeatGenerator root = CommonFactory.eINSTANCE.createToggleHeartbeatGenerator ();
