...
{
    public static final Comparator<MavenDependency> COMPARATOR = Comparator.comparing ( MavenDependency::getGroupId ).thenComparing ( MavenDependency::getArtifactId ).thenComparing ( MavenDependency::getVersion );
