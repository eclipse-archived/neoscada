...
public class DriverInformation implements org.eclipse.scada.core.client.DriverInformation
{
    ...
    public DriverInformation ( final SocketConnector socketConnector )
    {
    ...
    public Connection create ( final ConnectionInformation connectionInformation )
    {
        ...
        try
        {
            return new org.eclipse.scada.da.client.ngp.ConnectionImpl ( connectionInformation, this.socketConnector );
        }
